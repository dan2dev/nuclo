...
setupHelp();
Se você não quiser usar mais closures, você pode usar a palavra-chave let ou const:
...
Outra alternativa poderia ser usar forEach() para iterar sobre o array helpText e anexar um ouvinte a cada <input>, conforme mostrado:
