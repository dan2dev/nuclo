...
export const gettingStartedCode = {
  ...
  denoUsage: { lang: 'typescript', code: `import 'nuclo';` },
  tsconfigTypes: { lang: 'json', code: `{
  "compilerOptions": {
    "types": ["nuclo/types"]
  }
}` },
  typesReference: { lang: 'typescript', code: `/// <reference types="nuclo/types" />` },
  firstApp: { lang: 'typescript', code: `import 'nuclo';
...
render(app, document.body);` },
  batchUpdates: { lang: 'typescript', code: `// Good: Multiple changes, single update
...
button(buttonStyle, 'Click me');` },
  responsiveStyles: { lang: 'typescript', code: `const responsiveCard = cn(
