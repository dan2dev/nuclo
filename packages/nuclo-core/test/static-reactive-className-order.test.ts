...
describe("Static and reactive className ordering", () => {
  ...
  it("should apply both classes when static className comes before reactive className", () => {
    ...
    const element = (globalThis as any).div("text", staticClass, () =>
    ...
    const staticClassName =
      typeof staticClass === "string" ? staticClass : staticClass.className;
    const reactiveClassName1 =
      typeof reactiveClass1 === "string"
        ? reactiveClass1
        : reactiveClass1.className;
    ...
    const reactiveClassName2 =
      typeof reactiveClass2 === "string"
        ? reactiveClass2
        : reactiveClass2.className;
  ...
  it("should handle multiple static classes with reactive className", () => {
    ...
    const staticClassName1 =
      typeof staticClass1 === "string" ? staticClass1 : staticClass1.className;
    const staticClassName2 =
      typeof staticClass2 === "string" ? staticClass2 : staticClass2.className;
    const reactiveClassName =
      typeof reactiveClass === "string"
        ? reactiveClass
        : reactiveClass.className;
  ...
  it("should work with the example from the issue - static then reactive", () => {
    ...
    const element = (globalThis as any).div("olá", p20, () => pgBlue);
    ...
    const pgBlueClassName =
      typeof pgBlue === "string" ? pgBlue : pgBlue.className;
  ...
  it("should work with the example from the issue - reactive then static", () => {
    ...
    const element = (globalThis as any).div("olá", () => pgBlue, p20);
