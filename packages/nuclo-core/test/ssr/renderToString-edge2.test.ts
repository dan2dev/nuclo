...
describe("renderToString – function returning non-element (line 201)", () => {
  ...
  it("returns empty string when input is null", () => {
    expect(
      renderToString(null as unknown as Parameters<typeof renderToString>[0]),
    ).toBe("");
  });
  ...
  it("returns empty string when input is undefined", () => {
    expect(
      renderToString(
        undefined as unknown as Parameters<typeof renderToString>[0],
      ),
    ).toBe("");
  });
...
describe("renderToString – polyfill element with children array (line 104)", () => {
  it("serializes NucloElement children via children array path", () => {
    ...
    (parent as unknown as { appendChild: (n: unknown) => void }).appendChild(
      child,
    );
...
describe("renderToStringWithContainer", () => {
  ...
  it("applies container attributes", () => {
    const el = document.createElement("div");
    const result = renderToStringWithContainer(el, "main", {
      id: "app",
      class: "root",
    });
