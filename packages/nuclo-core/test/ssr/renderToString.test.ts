...
describe("SSR renderToString", () => {
  ...
  describe("renderToString", () => {
    ...
    it("should render nested elements", () => {
      const html = renderToString(div(span("Nested"), span("Content")));
    ...
    it("should handle boolean attributes", () => {
      const html = renderToString(input({ type: "checkbox", checked: true }));
  ...
  describe("renderToStringWithContainer", () => {
    ...
    it("should wrap content in custom container", () => {
      ...
      expect(html).toBe(
        "<section><span><!-- text-0 -->Content</span></section>",
      );
    });

    it("should apply container attributes", () => {
      const html = renderToStringWithContainer(span("Content"), "div", {
        id: "wrapper",
        class: "container",
      });
      expect(html).toContain("<div");
