...
declare global {
  ...
  export type StyleQueryStyles<TDefinitions extends StyleQueryDefinitions> =
    Partial<
      Record<InferStyleQueryKeys<TDefinitions> | CSSPseudoClass, StyleBuilder>
    >;

  export type StyleQueryResult = { className: string };

  export interface StyleQueryBuilder<
    TDefinitions extends StyleQueryDefinitions,
  > {
    (
      defaultStyles: StyleBuilder,
      queryStyles?: StyleQueryStyles<TDefinitions>,
    ): StyleQueryResult;
  ...
  class StyleBuilder {
    ...
    flex(
      value?: CSSLengthValue | "auto" | "initial" | "none" | "1" | "0",
    ): this;
    grid(): this;
    ...
    borderBottomWidth(
      value: CSSLengthValue | "thin" | "medium" | "thick",
    ): this;
  ...
  function textDecorationThickness(
    value: CSSLengthValue | "auto" | "from-font",
  ): StyleBuilder;
  ...
  function flexBasis(
    value: CSSLengthValue | "auto" | "content" | "fit-content",
  ): StyleBuilder;
  ...
  function backgroundImage(
    value: CSSBackgroundImageValue | "none",
  ): StyleBuilder;
  ...
  function backgroundSize(
    value: CSSLengthValue | "auto" | "cover" | "contain",
  ): StyleBuilder;
  ...
  function borderBlockStartWidth(
    value: CSSLengthValue | "thin" | "medium" | "thick",
  ): StyleBuilder;
  function borderBlockEndWidth(
    value: CSSLengthValue | "thin" | "medium" | "thick",
  ): StyleBuilder;
  function borderInlineWidth(
    value: CSSLengthValue | "thin" | "medium" | "thick",
  ): StyleBuilder;
  function borderInlineStartWidth(
    value: CSSLengthValue | "thin" | "medium" | "thick",
  ): StyleBuilder;
  function borderInlineEndWidth(
    value: CSSLengthValue | "thin" | "medium" | "thick",
  ): StyleBuilder;
...
export function lineHeight(
  value: CSSLengthValue | "normal" | number,
): StyleBuilder;
...
export function backgroundAttachment(
  value: BackgroundAttachmentValue,
): StyleBuilder;
...
export function listStyleImage(
  value: CSSBackgroundImageValue | "none",
): StyleBuilder;
...
export function content(
  value: CSSContentValue | "normal" | "none",
): StyleBuilder;
...
export function columnRuleWidth(
  value: CSSLengthValue | "thin" | "medium" | "thick",
): StyleBuilder;
...
export function backgroundBlendMode(
  value: BackgroundBlendModeValue,
): StyleBuilder;
...
export function borderImageSource(
  value: CSSBackgroundImageValue | "none",
): StyleBuilder;
...
export function borderBlockWidth(
  value: CSSLengthValue | "thin" | "medium" | "thick",
): StyleBuilder;
export function borderBlockStartWidth(
  value: CSSLengthValue | "thin" | "medium" | "thick",
): StyleBuilder;
export function borderBlockEndWidth(
  value: CSSLengthValue | "thin" | "medium" | "thick",
): StyleBuilder;
export function borderInlineWidth(
  value: CSSLengthValue | "thin" | "medium" | "thick",
): StyleBuilder;
export function borderInlineStartWidth(
  value: CSSLengthValue | "thin" | "medium" | "thick",
): StyleBuilder;
export function borderInlineEndWidth(
  value: CSSLengthValue | "thin" | "medium" | "thick",
): StyleBuilder;
...
export function textCombineUpright(
  value: TextCombineUprightValue,
): StyleBuilder;
...
export function createStyleQueries<T extends string>(
  ...
  (
    defaultStyles: StyleBuilder,
    queryStyles?: Partial<Record<T | CSSPseudoClass, StyleBuilder>>,
...
export function createBreakpoints<T extends string>(
  ...
  (
    defaultStyles: StyleBuilder,
    breakpointStyles?: Partial<Record<T | CSSPseudoClass, StyleBuilder>>,
  ): { className: string } | string;
  (
    breakpointStyles?: Partial<Record<T | CSSPseudoClass, StyleBuilder>>,
  ): { className: string } | string;
