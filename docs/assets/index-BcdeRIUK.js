(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))s(l);new MutationObserver(l=>{for(const c of l)if(c.type==="childList")for(const m of c.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&s(m)}).observe(document,{childList:!0,subtree:!0});function i(l){const c={};return l.integrity&&(c.integrity=l.integrity),l.referrerPolicy&&(c.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?c.credentials="include":l.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function s(l){if(l.ep)return;l.ep=!0;const c=i(l);fetch(l.href,c)}})();function ge(e){return e===null||typeof e!="object"&&typeof e!="function"}function ie(e){return e instanceof Node}function X(e){return typeof e=="object"&&e!==null}function je(e){return X(e)&&"tagName"in e}function H(e){return typeof e=="function"}function ot(e){return H(e)&&e.length===0}function pe(e,r){try{return e()}catch{return r}}const U=typeof window<"u"&&typeof document<"u";function rt(e){if(!e?.parentNode)return!1;try{return e.parentNode.removeChild(e),!0}catch{return!1}}function We(e){if(!U)return null;try{return document.createComment(e)}catch{return null}}function $e(e){return We(e)}function ee(e,r="hidden"){try{return document.createComment(`conditional-${e}-${r}`)}catch{return null}}function xt(e){if(!U)throw Error("Cannot create comment in non-browser environment");const r=We(`${e}-${Math.random().toString(36).slice(2)}`);if(!r)throw Error("Failed to create comment");return r}function nt(e){const r=We(e+"-end");if(!r)throw Error("Failed to create end comment");return{start:xt(e+"-start"),end:r}}function Oe(e){return!!e&&(typeof e.isConnected=="boolean"?e.isConnected:!(!U||typeof document>"u")&&document.contains(e))}function Ue(e,r){if(!e?.parentNode)return!1;try{return e.parentNode.replaceChild(r,e),!0}catch{return!1}}const Pe=new Map,le=new Map;function it(e,r){r.attributeResolvers.forEach(({resolver:i,applyValue:s},l)=>{try{s(pe(i))}catch{}})}function he(e,r,i,s){if(!(e instanceof Element&&r&&typeof i=="function"))return;const l=(function(c){let m=le.get(c);return m||(m={attributeResolvers:new Map},le.set(c,m)),m})(e);l.attributeResolvers.set(r,{resolver:i,applyValue:s});try{s(pe(i))}catch{}if(!l.updateListener){const c=()=>it(0,l);e.addEventListener("update",c),l.updateListener=c}}function vt(e,r,i){try{return i==null||i===""?(e.style[r]="",!0):(e.style[r]=i+"",!0)}catch{return!1}}function Ge(e,r){if(e?.style&&r)for(const[i,s]of Object.entries(r))vt(e,i,s)||void 0}const Qe="__nuclo_reactive_className__",G="__nuclo_static_className__";function St(e,r,i,s=!1){if(i==null)return;if(r==="style")return c=i,void((l=e)&&(H(c)?he(l,"style",()=>{try{return c()}catch{return null}},f=>{Ge(l,f)}):Ge(l,c)));var l,c;const m=(f,S=!1)=>{if(f!=null)if(r==="className"&&e instanceof HTMLElement&&S)(function(b,v){if(!v)return;const u=b.className;if(u&&u!==v){const x=new Set(u.split(" ").filter(h=>h));v.split(" ").filter(h=>h).forEach(h=>x.add(h)),b.className=Array.from(x).join(" ")}else b.className=v})(e,f+"");else if(e instanceof Element&&e.namespaceURI==="http://www.w3.org/2000/svg")e.setAttribute(r+"",f+"");else if(r in e)try{e[r]=f}catch{e instanceof Element&&e.setAttribute(r+"",f+"")}else e instanceof Element&&e.setAttribute(r+"",f+"")};if(H(i)&&i.length===0){const f=i;r==="className"&&e instanceof HTMLElement?((function(S){S[G]||(S[G]=new Set(S.className.split(" ").filter(b=>b))),S[Qe]=!0})(e),he(e,r+"",f,S=>{(function(b,v){const u=(function(x){return x[G]})(b);if(u&&u.size>0&&v){const x=new Set(u);v.split(" ").filter(h=>h).forEach(h=>x.add(h)),b.className=Array.from(x).join(" ")}else b.className=v||(u&&u.size>0?Array.from(u).join(" "):"")})(e,(S||"")+"")})):he(e,r+"",f,S=>{m(S,!1)})}else{if(r==="className"&&e instanceof HTMLElement&&(function(f){return!!f[Qe]})(e)){const f=(i||"")+"";if(f){(function(b,v){v&&(b[G]||(b[G]=new Set),v.split(" ").filter(u=>u).forEach(u=>{b[G].add(u)}))})(e,f);const S=new Set(e.className.split(" ").filter(b=>b));f.split(" ").filter(b=>b).forEach(b=>S.add(b)),e.className=Array.from(S).join(" ")}return}m(i,s)}}function fe(e,r,i=!0){if(r)for(const s of Object.keys(r))St(e,s,r[s],i&&s==="className")}const O=new WeakMap;function kt(e,r,i){if(!H(e)||e.length!==0||!(function(l){const{value:c,error:m}=(function(f){const S=O.get(f);if(S)return S;try{const b={value:f(),error:!1};return O.set(f,b),b}catch{const b={value:void 0,error:!0};return O.set(f,b),b}})(l);return!m&&typeof c=="boolean"})(e))return!1;const s=r.filter((l,c)=>c!==i);return s.length!==0&&s.some(l=>!!(X(l)||ie(l)||H(l)&&l.length>0))}function ae(e,r,i){if(r==null)return null;if(H(r)){if(ot(r))try{let c=O.get(r);if(c||(c={value:r(),error:!1},O.set(r,c)),c.error)return ye(i,()=>"");const m=c.value;if(X(m)&&!ie(m)&&"className"in m&&typeof m.className=="string"&&Object.keys(m).length===1){const f=r;return fe(e,{className:()=>f().className}),null}return ge(m)&&m!=null?ye(i,r,m):null}catch{return O.set(r,{value:void 0,error:!0}),ye(i,()=>"")}const l=r(e,i);return l==null?null:ge(l)?qe(i,l):ie(l)?l:(X(l)&&fe(e,l),null)}const s=r;return s==null?null:ge(s)?qe(i,s):ie(s)?s:(X(s)&&fe(e,s),null)}function ye(e,r,i){const s=document.createDocumentFragment(),l=$e(` text-${e} `);l&&s.appendChild(l);const c=(function(m,f){if(typeof m!="function")return document.createTextNode("");const S=arguments.length>1?f:pe(m,""),b=S===void 0?"":S+"",v=document.createTextNode(b);return Pe.set(v,{resolver:m,lastValue:b}),v})(r,i);return s.appendChild(c),s}function qe(e,r){const i=document.createDocumentFragment(),s=$e(` text-${e} `);s&&i.appendChild(s);const l=document.createTextNode(r+"");return i.appendChild(l),i}const Te=new Set;function _(e,r){e._conditionalInfo=r,Te.add(e)}function ue(e,r,i=0){if(!r||r.length===0)return{element:e,nextIndex:i,appended:0};let s=i,l=0;const c=e;for(let m=0;r.length>m;m+=1){const f=r[m];if(f==null)continue;const S=ae(e,f,s);S&&(S.parentNode!==c&&c.appendChild(S),s+=1,l+=1)}return{element:e,nextIndex:s,appended:l}}function Be(e,r){const i=document.createElement(e);return ue(i,r,0),i}function Re(e,r){const i=document.createElementNS("http://www.w3.org/2000/svg",e);return ue(i,r,0),i}function wt(e){return(...r)=>(function(i,...s){return(l,c)=>{const{condition:m,otherModifiers:f}=(function(b){const v=(function(u){for(let x=0;u.length>x;x+=1)if(kt(u[x],u,x))return x;return-1})(b);return v===-1?{condition:null,otherModifiers:b}:{condition:b[v],otherModifiers:b.filter((u,x)=>x!==v)}})(s);if(m)return(function(b,v,u){const x=v();if(!U)return x?Be(b,u):ee(b,"ssr");const h={condition:v,tagName:b,modifiers:u,isSvg:!1};if(x){const k=Be(b,u);return _(k,h),k}const g=ee(b);if(!g)throw Error("Failed to create conditional comment for "+b);return _(g,h),g})(i,m,f);const S=document.createElement(i);return ue(S,f,c),S}})(e,...r)}function Ct(e){return(...r)=>(function(i,...s){return(l,c)=>{const m=s.findIndex(S=>typeof S=="function"&&S.length===0);if(m!==-1){const S=s[m],b=s.filter((v,u)=>u!==m);return(function(v,u,x){const h=u();if(!U)return h?Re(v,x):ee(v,"ssr");const g={condition:u,tagName:v,modifiers:x,isSvg:!0};if(h){const T=Re(v,x);return _(T,g),T}const k=ee(v);if(!k)throw Error("Failed to create conditional comment for "+v);return _(k,g),k})(i,S,b)}const f=document.createElementNS("http://www.w3.org/2000/svg",i);return ue(f,s,c),f}})(e,...r)}const Pt=["a","abbr","address","area","article","aside","audio","b","base","bdi","bdo","blockquote","body","br","button","canvas","caption","cite","code","col","colgroup","data","datalist","dd","del","details","dfn","dialog","div","dl","dt","em","embed","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","iframe","img","input","ins","kbd","label","legend","li","link","main","map","mark","menu","meta","meter","nav","noscript","object","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","script","search","section","select","slot","small","source","span","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","title","tr","track","u","ul","var","video","wbr"],Tt=["a","animate","animateMotion","animateTransform","circle","clipPath","defs","desc","ellipse","feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence","filter","foreignObject","g","image","line","linearGradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialGradient","rect","script","set","stop","style","svg","switch","symbol","text","textPath","title","tspan","use","view"];function Bt(e=globalThis){const r="__nuclo_tags_registered";e[r]||(Tt.forEach(i=>(function(s,l){const c=l+"Svg";c in s||(s[c]=Ct(l))})(e,i)),Pt.forEach(i=>(function(s,l){l in s&&typeof s[l]!="function"||(s[l]=wt(l))})(e,i)),e[r]=!0)}const ze=new Set;function Rt(e,r,i){return(function(s,l,c){if(H(s)){const m=s(l,c);return m&&je(m)?m:null}return s&&je(s)?s:null})(e.renderItem(r,i),e.host,i)}function zt(e){rt(e.element)}function at(e){const{host:r,startMarker:i,endMarker:s}=e,l=i.parentNode??r,c=e.itemsProvider();if((function(u,x){if(u===x)return!0;if(u.length!==x.length)return!1;for(let h=0;u.length>h;h++)if((h in u?u[h]:void 0)!==(h in x?x[h]:void 0))return!1;return!0})(e.lastSyncedItems,c))return;const m=new Map,f=new Map;e.records.forEach(u=>{const x=f.get(u.item);x?x.push(u):f.set(u.item,[u])}),c.forEach((u,x)=>{if(e.lastSyncedItems.length>x&&e.lastSyncedItems[x]===u){const h=e.records[x];if(h&&h.item===u){m.set(x,h);const g=f.get(u);if(g){const k=g.indexOf(h);0>k||(g.splice(k,1),g.length===0&&f.delete(u))}}}});const S=[],b=new Set(e.records);let v=s;for(let u=c.length-1;u>=0;u--){const x=c[u];let h=m.get(u);if(!h){const k=f.get(x);k&&k.length>0&&(h=k.shift(),k.length===0&&f.delete(x))}if(h)b.delete(h);else{const k=Rt(e,x,u);if(!k)continue;h={item:x,element:k}}S.unshift(h);const g=h.element;g.nextSibling!==v&&l.insertBefore(g,v),v=g}b.forEach(zt),e.records=S,e.lastSyncedItems=[...c]}function At(e,r){return(i,s)=>(function(c,m,f){const{start:S,end:b}=nt("list"),v={itemsProvider:c,renderItem:m,startMarker:S,endMarker:b,records:[],host:f,lastSyncedItems:[]},u=f;return u.appendChild(S),u.appendChild(b),ze.add(v),at(v),v})(e,r,i).startMarker}function st(e,r){try{return e()}catch(i){if(r)return r(i),!1;throw i}}function It(e,r){return typeof e=="function"?st(e,r):!!e}function Nt(e,r,i,s){return H(e)?ot(e)?(O.delete(e),ae(r,e,i)):(function(l,c,m){const f=l,S=f.appendChild.bind(f),b=f.insertBefore.bind(f);f.appendChild=function(v){return b(v,c)};try{return m()}finally{f.appendChild=S}})(r,s,()=>{const l=ae(r,e,i);return l&&!l.parentNode?l:null}):ae(r,e,i)}const Ae=new Set;function Ve(e){const{groups:r,elseContent:i,host:s,index:l,endMarker:c}=e,m=(function(S,b){for(let v=0;S.length>v;v++)if(It(S[v].condition))return v;return b.length>0?-1:null})(r,i);if(m===e.activeIndex||((function(S,b){let v=S.nextSibling;for(;v&&v!==b;){const u=v.nextSibling;rt(v),v=u}})(e.startMarker,e.endMarker),e.activeIndex=m,m===null))return;const f=(function(S,b,v,u){const x=[];for(const h of S){const g=Nt(h,b,v,u);g&&x.push(g)}return x})(0>m?i:r[m].content,s,l,c);(function(S,b){const v=b.parentNode;v&&S.forEach(u=>(function(x,h,g){if(!x||!h)return!1;try{return x.insertBefore(h,g),!0}catch{return!1}})(v,u,b))})(f,c)}class Et{groups=[];elseContent=[];constructor(r,...i){this.groups.push({condition:r,content:i})}when(r,...i){return this.groups.push({condition:r,content:i}),this}else(...r){return this.elseContent=r,this}render(r,i){if(!U)return $e("when-ssr")||null;const{start:s,end:l}=nt("when"),c={startMarker:s,endMarker:l,host:r,index:i,groups:[...this.groups],elseContent:[...this.elseContent],activeIndex:null,update:()=>Ve(c)};(function(f){Ae.add(f)})(c);const m=r;return m.appendChild(s),m.appendChild(l),Ve(c),s}}function Ie(e){return Object.assign((r,i)=>e.render(r,i),{when:(r,...i)=>(e.when(r,...i),Ie(e)),else:(...r)=>(e.else(...r),Ie(e))})}function Mt(e,...r){return Ie(new Et(e,...r))}const Wt=[function(){ze.forEach(e=>{e.startMarker.isConnected&&e.endMarker.isConnected?at(e):ze.delete(e)})},function(){Ae.forEach(e=>{try{e.update()}catch{Ae.delete(e)}})},function(){if(U)try{Te.forEach(e=>{e.isConnected?(function(r){const i=(function(c){return c._conditionalInfo??null})(r);if(!i)return;const s=st(i.condition,c=>{}),l=r.nodeType===Node.ELEMENT_NODE;if(s&&!l){const c=(function(m){try{return m.isSvg?Re(m.tagName,m.modifiers):Be(m.tagName,m.modifiers)}catch{return m.isSvg?document.createElementNS("http://www.w3.org/2000/svg",m.tagName):document.createElement(m.tagName)}})(i);_(c,i),Ue(r,c)}else if(!s&&l){const c=ee(i.tagName);c&&(_(c,i),Ue(r,c))}})(e):(function(r){Te.delete(r)})(e)})}catch{}},function(){le.forEach((e,r)=>{if(!Oe(r))return e.updateListener&&r.removeEventListener("update",e.updateListener),void le.delete(r);it(0,e)})},function(){Pe.forEach((e,r)=>{if(Oe(r))try{const i=pe(e.resolver),s=i===void 0?"":i+"";s!==e.lastValue&&(r.textContent=s,e.lastValue=s)}catch{}else Pe.delete(r)})},function(){if(typeof document>"u")return;const e=document.body?[document.body,document]:[document];for(const r of e)try{r.dispatchEvent(new Event("update",{bubbles:!0}))}catch{}}];function $t(){for(const e of Wt)e()}function Dt(e,r,i){return s=>{if(!s||typeof s.addEventListener!="function")return;const l=s;l.addEventListener(e,c=>{try{r.call(l,c)}catch{}},i)}}function Lt(e,r,i=0){const s=e(r||document.body,i);return(r||document.body).appendChild(s),s}const lt=[{name:"display",cssProperty:"display"},{name:"grid",cssProperty:"display",defaultValue:"grid",isShorthand:!0},{name:"bg",cssProperty:"background-color"},{name:"color",cssProperty:"color"},{name:"accentColor",cssProperty:"accent-color"},{name:"fontSize",cssProperty:"font-size"},{name:"fontWeight",cssProperty:"font-weight"},{name:"fontFamily",cssProperty:"font-family"},{name:"lineHeight",cssProperty:"line-height"},{name:"letterSpacing",cssProperty:"letter-spacing"},{name:"textAlign",cssProperty:"text-align"},{name:"textDecoration",cssProperty:"text-decoration"},{name:"fontStyle",cssProperty:"font-style"},{name:"fontVariant",cssProperty:"font-variant"},{name:"fontStretch",cssProperty:"font-stretch"},{name:"textTransform",cssProperty:"text-transform"},{name:"textIndent",cssProperty:"text-indent"},{name:"textOverflow",cssProperty:"text-overflow"},{name:"textShadow",cssProperty:"text-shadow"},{name:"whiteSpace",cssProperty:"white-space"},{name:"wordSpacing",cssProperty:"word-spacing"},{name:"wordWrap",cssProperty:"word-wrap"},{name:"overflowWrap",cssProperty:"overflow-wrap"},{name:"textAlignLast",cssProperty:"text-align-last"},{name:"textJustify",cssProperty:"text-justify"},{name:"textDecorationLine",cssProperty:"text-decoration-line"},{name:"textDecorationColor",cssProperty:"text-decoration-color"},{name:"textDecorationStyle",cssProperty:"text-decoration-style"},{name:"textDecorationThickness",cssProperty:"text-decoration-thickness"},{name:"textUnderlineOffset",cssProperty:"text-underline-offset"},{name:"verticalAlign",cssProperty:"vertical-align"},{name:"position",cssProperty:"position"},{name:"padding",cssProperty:"padding"},{name:"paddingTop",cssProperty:"padding-top"},{name:"paddingRight",cssProperty:"padding-right"},{name:"paddingBottom",cssProperty:"padding-bottom"},{name:"paddingLeft",cssProperty:"padding-left"},{name:"margin",cssProperty:"margin"},{name:"marginTop",cssProperty:"margin-top"},{name:"marginRight",cssProperty:"margin-right"},{name:"marginBottom",cssProperty:"margin-bottom"},{name:"marginLeft",cssProperty:"margin-left"},{name:"width",cssProperty:"width"},{name:"height",cssProperty:"height"},{name:"minWidth",cssProperty:"min-width"},{name:"maxWidth",cssProperty:"max-width"},{name:"minHeight",cssProperty:"min-height"},{name:"maxHeight",cssProperty:"max-height"},{name:"boxSizing",cssProperty:"box-sizing"},{name:"top",cssProperty:"top"},{name:"right",cssProperty:"right"},{name:"bottom",cssProperty:"bottom"},{name:"left",cssProperty:"left"},{name:"zIndex",cssProperty:"z-index"},{name:"flexDirection",cssProperty:"flex-direction"},{name:"alignItems",cssProperty:"align-items"},{name:"justifyContent",cssProperty:"justify-content"},{name:"gap",cssProperty:"gap"},{name:"flexWrap",cssProperty:"flex-wrap"},{name:"flexGrow",cssProperty:"flex-grow"},{name:"flexShrink",cssProperty:"flex-shrink"},{name:"flexBasis",cssProperty:"flex-basis"},{name:"alignSelf",cssProperty:"align-self"},{name:"alignContent",cssProperty:"align-content"},{name:"justifySelf",cssProperty:"justify-self"},{name:"justifyItems",cssProperty:"justify-items"},{name:"gridTemplateColumns",cssProperty:"grid-template-columns"},{name:"gridTemplateRows",cssProperty:"grid-template-rows"},{name:"gridTemplateAreas",cssProperty:"grid-template-areas"},{name:"gridColumn",cssProperty:"grid-column"},{name:"gridRow",cssProperty:"grid-row"},{name:"gridColumnStart",cssProperty:"grid-column-start"},{name:"gridColumnEnd",cssProperty:"grid-column-end"},{name:"gridRowStart",cssProperty:"grid-row-start"},{name:"gridRowEnd",cssProperty:"grid-row-end"},{name:"gridArea",cssProperty:"grid-area"},{name:"gridAutoColumns",cssProperty:"grid-auto-columns"},{name:"gridAutoRows",cssProperty:"grid-auto-rows"},{name:"gridAutoFlow",cssProperty:"grid-auto-flow"},{name:"border",cssProperty:"border"},{name:"borderTop",cssProperty:"border-top"},{name:"borderRight",cssProperty:"border-right"},{name:"borderBottom",cssProperty:"border-bottom"},{name:"borderLeft",cssProperty:"border-left"},{name:"borderWidth",cssProperty:"border-width"},{name:"borderStyle",cssProperty:"border-style"},{name:"borderColor",cssProperty:"border-color"},{name:"borderTopWidth",cssProperty:"border-top-width"},{name:"borderRightWidth",cssProperty:"border-right-width"},{name:"borderBottomWidth",cssProperty:"border-bottom-width"},{name:"borderLeftWidth",cssProperty:"border-left-width"},{name:"borderTopStyle",cssProperty:"border-top-style"},{name:"borderRightStyle",cssProperty:"border-right-style"},{name:"borderBottomStyle",cssProperty:"border-bottom-style"},{name:"borderLeftStyle",cssProperty:"border-left-style"},{name:"borderTopColor",cssProperty:"border-top-color"},{name:"borderRightColor",cssProperty:"border-right-color"},{name:"borderBottomColor",cssProperty:"border-bottom-color"},{name:"borderLeftColor",cssProperty:"border-left-color"},{name:"borderRadius",cssProperty:"border-radius"},{name:"borderTopLeftRadius",cssProperty:"border-top-left-radius"},{name:"borderTopRightRadius",cssProperty:"border-top-right-radius"},{name:"borderBottomLeftRadius",cssProperty:"border-bottom-left-radius"},{name:"borderBottomRightRadius",cssProperty:"border-bottom-right-radius"},{name:"outline",cssProperty:"outline"},{name:"outlineWidth",cssProperty:"outline-width"},{name:"outlineStyle",cssProperty:"outline-style"},{name:"outlineColor",cssProperty:"outline-color"},{name:"outlineOffset",cssProperty:"outline-offset"},{name:"backgroundColor",cssProperty:"background-color"},{name:"backgroundImage",cssProperty:"background-image"},{name:"backgroundRepeat",cssProperty:"background-repeat"},{name:"backgroundPosition",cssProperty:"background-position"},{name:"backgroundSize",cssProperty:"background-size"},{name:"backgroundAttachment",cssProperty:"background-attachment"},{name:"backgroundClip",cssProperty:"background-clip"},{name:"backgroundOrigin",cssProperty:"background-origin"},{name:"boxShadow",cssProperty:"box-shadow"},{name:"opacity",cssProperty:"opacity"},{name:"transition",cssProperty:"transition"},{name:"transitionProperty",cssProperty:"transition-property"},{name:"transitionDuration",cssProperty:"transition-duration"},{name:"transitionTimingFunction",cssProperty:"transition-timing-function"},{name:"transitionDelay",cssProperty:"transition-delay"},{name:"transform",cssProperty:"transform"},{name:"transformOrigin",cssProperty:"transform-origin"},{name:"transformStyle",cssProperty:"transform-style"},{name:"perspective",cssProperty:"perspective"},{name:"perspectiveOrigin",cssProperty:"perspective-origin"},{name:"backfaceVisibility",cssProperty:"backface-visibility"},{name:"animation",cssProperty:"animation"},{name:"animationName",cssProperty:"animation-name"},{name:"animationDuration",cssProperty:"animation-duration"},{name:"animationTimingFunction",cssProperty:"animation-timing-function"},{name:"animationDelay",cssProperty:"animation-delay"},{name:"animationIterationCount",cssProperty:"animation-iteration-count"},{name:"animationDirection",cssProperty:"animation-direction"},{name:"animationFillMode",cssProperty:"animation-fill-mode"},{name:"animationPlayState",cssProperty:"animation-play-state"},{name:"filter",cssProperty:"filter"},{name:"backdropFilter",cssProperty:"backdrop-filter"},{name:"overflow",cssProperty:"overflow"},{name:"overflowX",cssProperty:"overflow-x"},{name:"overflowY",cssProperty:"overflow-y"},{name:"visibility",cssProperty:"visibility"},{name:"objectFit",cssProperty:"object-fit"},{name:"objectPosition",cssProperty:"object-position"},{name:"listStyle",cssProperty:"list-style"},{name:"listStyleType",cssProperty:"list-style-type"},{name:"listStylePosition",cssProperty:"list-style-position"},{name:"listStyleImage",cssProperty:"list-style-image"},{name:"borderCollapse",cssProperty:"border-collapse"},{name:"borderSpacing",cssProperty:"border-spacing"},{name:"captionSide",cssProperty:"caption-side"},{name:"emptyCells",cssProperty:"empty-cells"},{name:"tableLayout",cssProperty:"table-layout"},{name:"content",cssProperty:"content"},{name:"quotes",cssProperty:"quotes"},{name:"counterReset",cssProperty:"counter-reset"},{name:"counterIncrement",cssProperty:"counter-increment"},{name:"appearance",cssProperty:"appearance"},{name:"userSelect",cssProperty:"user-select"},{name:"pointerEvents",cssProperty:"pointer-events"},{name:"resize",cssProperty:"resize"},{name:"scrollBehavior",cssProperty:"scroll-behavior"},{name:"clip",cssProperty:"clip"},{name:"clipPath",cssProperty:"clip-path"},{name:"isolation",cssProperty:"isolation"},{name:"mixBlendMode",cssProperty:"mix-blend-mode"},{name:"willChange",cssProperty:"will-change"},{name:"contain",cssProperty:"contain"},{name:"pageBreakBefore",cssProperty:"page-break-before"},{name:"pageBreakAfter",cssProperty:"page-break-after"},{name:"pageBreakInside",cssProperty:"page-break-inside"},{name:"breakBefore",cssProperty:"break-before"},{name:"breakAfter",cssProperty:"break-after"},{name:"breakInside",cssProperty:"break-inside"},{name:"orphans",cssProperty:"orphans"},{name:"widows",cssProperty:"widows"},{name:"columnCount",cssProperty:"column-count"},{name:"columnFill",cssProperty:"column-fill"},{name:"columnGap",cssProperty:"column-gap"},{name:"columnRule",cssProperty:"column-rule"},{name:"columnRuleColor",cssProperty:"column-rule-color"},{name:"columnRuleStyle",cssProperty:"column-rule-style"},{name:"columnRuleWidth",cssProperty:"column-rule-width"},{name:"columnSpan",cssProperty:"column-span"},{name:"columnWidth",cssProperty:"column-width"},{name:"columns",cssProperty:"columns"},{name:"cursor",cssProperty:"cursor"},{name:"aspectRatio",cssProperty:"aspect-ratio"},{name:"clear",cssProperty:"clear"},{name:"float",cssProperty:"float"},{name:"order",cssProperty:"order"},{name:"placeContent",cssProperty:"place-content"},{name:"placeItems",cssProperty:"place-items"},{name:"placeSelf",cssProperty:"place-self"},{name:"hyphens",cssProperty:"hyphens"},{name:"lineBreak",cssProperty:"line-break"},{name:"wordBreak",cssProperty:"word-break"},{name:"textOrientation",cssProperty:"text-orientation"},{name:"writingMode",cssProperty:"writing-mode"},{name:"direction",cssProperty:"direction"},{name:"unicodeBidi",cssProperty:"unicode-bidi"},{name:"backgroundBlendMode",cssProperty:"background-blend-mode"},{name:"backgroundPositionX",cssProperty:"background-position-x"},{name:"backgroundPositionY",cssProperty:"background-position-y"},{name:"borderImage",cssProperty:"border-image"},{name:"borderImageSource",cssProperty:"border-image-source"},{name:"borderImageSlice",cssProperty:"border-image-slice"},{name:"borderImageWidth",cssProperty:"border-image-width"},{name:"borderImageOutset",cssProperty:"border-image-outset"},{name:"borderImageRepeat",cssProperty:"border-image-repeat"},{name:"inset",cssProperty:"inset"},{name:"insetBlock",cssProperty:"inset-block"},{name:"insetBlockStart",cssProperty:"inset-block-start"},{name:"insetBlockEnd",cssProperty:"inset-block-end"},{name:"insetInline",cssProperty:"inset-inline"},{name:"insetInlineStart",cssProperty:"inset-inline-start"},{name:"insetInlineEnd",cssProperty:"inset-inline-end"},{name:"marginBlock",cssProperty:"margin-block"},{name:"marginBlockStart",cssProperty:"margin-block-start"},{name:"marginBlockEnd",cssProperty:"margin-block-end"},{name:"marginInline",cssProperty:"margin-inline"},{name:"marginInlineStart",cssProperty:"margin-inline-start"},{name:"marginInlineEnd",cssProperty:"margin-inline-end"},{name:"paddingBlock",cssProperty:"padding-block"},{name:"paddingBlockStart",cssProperty:"padding-block-start"},{name:"paddingBlockEnd",cssProperty:"padding-block-end"},{name:"paddingInline",cssProperty:"padding-inline"},{name:"paddingInlineStart",cssProperty:"padding-inline-start"},{name:"paddingInlineEnd",cssProperty:"padding-inline-end"},{name:"inlineSize",cssProperty:"inline-size"},{name:"blockSize",cssProperty:"block-size"},{name:"minInlineSize",cssProperty:"min-inline-size"},{name:"minBlockSize",cssProperty:"min-block-size"},{name:"maxInlineSize",cssProperty:"max-inline-size"},{name:"maxBlockSize",cssProperty:"max-block-size"},{name:"borderBlock",cssProperty:"border-block"},{name:"borderBlockStart",cssProperty:"border-block-start"},{name:"borderBlockEnd",cssProperty:"border-block-end"},{name:"borderInline",cssProperty:"border-inline"},{name:"borderInlineStart",cssProperty:"border-inline-start"},{name:"borderInlineEnd",cssProperty:"border-inline-end"},{name:"borderBlockWidth",cssProperty:"border-block-width"},{name:"borderBlockStartWidth",cssProperty:"border-block-start-width"},{name:"borderBlockEndWidth",cssProperty:"border-block-end-width"},{name:"borderInlineWidth",cssProperty:"border-inline-width"},{name:"borderInlineStartWidth",cssProperty:"border-inline-start-width"},{name:"borderInlineEndWidth",cssProperty:"border-inline-end-width"},{name:"borderBlockStyle",cssProperty:"border-block-style"},{name:"borderBlockStartStyle",cssProperty:"border-block-start-style"},{name:"borderBlockEndStyle",cssProperty:"border-block-end-style"},{name:"borderInlineStyle",cssProperty:"border-inline-style"},{name:"borderInlineStartStyle",cssProperty:"border-inline-start-style"},{name:"borderInlineEndStyle",cssProperty:"border-inline-end-style"},{name:"borderBlockColor",cssProperty:"border-block-color"},{name:"borderBlockStartColor",cssProperty:"border-block-start-color"},{name:"borderBlockEndColor",cssProperty:"border-block-end-color"},{name:"borderInlineColor",cssProperty:"border-inline-color"},{name:"borderInlineStartColor",cssProperty:"border-inline-start-color"},{name:"borderInlineEndColor",cssProperty:"border-inline-end-color"},{name:"borderStartStartRadius",cssProperty:"border-start-start-radius"},{name:"borderStartEndRadius",cssProperty:"border-start-end-radius"},{name:"borderEndStartRadius",cssProperty:"border-end-start-radius"},{name:"borderEndEndRadius",cssProperty:"border-end-end-radius"},{name:"scrollMargin",cssProperty:"scroll-margin"},{name:"scrollMarginTop",cssProperty:"scroll-margin-top"},{name:"scrollMarginRight",cssProperty:"scroll-margin-right"},{name:"scrollMarginBottom",cssProperty:"scroll-margin-bottom"},{name:"scrollMarginLeft",cssProperty:"scroll-margin-left"},{name:"scrollPadding",cssProperty:"scroll-padding"},{name:"scrollPaddingTop",cssProperty:"scroll-padding-top"},{name:"scrollPaddingRight",cssProperty:"scroll-padding-right"},{name:"scrollPaddingBottom",cssProperty:"scroll-padding-bottom"},{name:"scrollPaddingLeft",cssProperty:"scroll-padding-left"},{name:"overscrollBehavior",cssProperty:"overscroll-behavior"},{name:"overscrollBehaviorX",cssProperty:"overscroll-behavior-x"},{name:"overscrollBehaviorY",cssProperty:"overscroll-behavior-y"},{name:"caretColor",cssProperty:"caret-color"},{name:"caretShape",cssProperty:"caret-shape"},{name:"caretAnimation",cssProperty:"caret-animation"},{name:"imageRendering",cssProperty:"image-rendering"},{name:"colorScheme",cssProperty:"color-scheme"},{name:"contentVisibility",cssProperty:"content-visibility"},{name:"touchAction",cssProperty:"touch-action"},{name:"containerType",cssProperty:"container-type"},{name:"containerName",cssProperty:"container-name"},{name:"container",cssProperty:"container"},{name:"fontFeatureSettings",cssProperty:"font-feature-settings"},{name:"fontKerning",cssProperty:"font-kerning"},{name:"fontSynthesis",cssProperty:"font-synthesis"},{name:"fontOpticalSizing",cssProperty:"font-optical-sizing"},{name:"fontDisplay",cssProperty:"font-display"},{name:"fontVariantCaps",cssProperty:"font-variant-caps"},{name:"fontVariantNumeric",cssProperty:"font-variant-numeric"},{name:"fontVariantLigatures",cssProperty:"font-variant-ligatures"},{name:"fontVariantEastAsian",cssProperty:"font-variant-east-asian"},{name:"fontVariantAlternates",cssProperty:"font-variant-alternates"},{name:"fontVariantPosition",cssProperty:"font-variant-position"},{name:"textRendering",cssProperty:"text-rendering"},{name:"textCombineUpright",cssProperty:"text-combine-upright"},{name:"textSizeAdjust",cssProperty:"text-size-adjust"},{name:"mask",cssProperty:"mask"},{name:"maskImage",cssProperty:"mask-image"},{name:"maskMode",cssProperty:"mask-mode"},{name:"maskRepeat",cssProperty:"mask-repeat"},{name:"maskPosition",cssProperty:"mask-position"},{name:"maskSize",cssProperty:"mask-size"},{name:"maskOrigin",cssProperty:"mask-origin"},{name:"maskClip",cssProperty:"mask-clip"},{name:"maskComposite",cssProperty:"mask-composite"},{name:"clipRule",cssProperty:"clip-rule"},{name:"gridColumnGap",cssProperty:"grid-column-gap"},{name:"gridRowGap",cssProperty:"grid-row-gap"},{name:"gridGap",cssProperty:"grid-gap"}],Ft=["bold","center","flex"],_e=new Map;function dt(e){let r=0;for(let i=0;e.length>i;i++)r=(r<<5)-r+e.charCodeAt(i),r&=r;return Math.abs(r).toString(16).padStart(8,"0").substring(0,8)}function Ne(e){return Object.entries(e).sort(([r],[i])=>r.localeCompare(i)).map(([r,i])=>`${r}:${i}`).join("|")}function V(e,r,i,s="media",l){let c=document.querySelector("#nuclo-styles");c||(c=document.createElement("style"),c.id="nuclo-styles",document.head.appendChild(c));const m=Object.entries(r).map(([f,S])=>`${f}: ${S}`).join("; ");if(l){const f=`.${e}${l}`,S=c.sheet;if(!S)return;const b=S.cssRules,v=b.length;let u=null,x=v;for(let h=0;v>h;h++){const g=b[h];if(g instanceof CSSStyleRule){if(g.selectorText===f){u=g,x=h;break}g.selectorText.includes(":")||(x=h+1)}}if(u){const h=u.style;h.cssText="";for(const[g,k]of Object.entries(r))h.setProperty(g,k)}else S.insertRule(`${f} { ${m} }`,x);return}if(i){const f=c.sheet;if(!f)return;const S=f.cssRules,b=S.length;let v=null;const u=g=>s==="media"&&g instanceof CSSMediaRule?g.media.mediaText===i:(s==="container"&&g instanceof CSSContainerRule||s==="supports"&&g instanceof CSSSupportsRule)&&g.conditionText===i,x=g=>g instanceof CSSMediaRule||g instanceof CSSContainerRule||g instanceof CSSSupportsRule;for(let g=0;b>g;g++){const k=S[g];if(u(k)){v=k;break}}if(!v){let g=b;for(let k=b-1;k>=0;k--){const T=S[k];if(x(T)){g=k+1;break}if(T instanceof CSSStyleRule){g=k+1;break}}f.insertRule(`${s==="media"?"@media":s==="container"?"@container":s==="supports"?"@supports":"@media"} ${i} {}`,g),v=f.cssRules[g]}let h=null;for(const g of Array.from(v.cssRules))if(g instanceof CSSStyleRule&&g.selectorText==="."+e){h=g;break}if(h){const g=h.style;g.cssText="";for(const[k,T]of Object.entries(r))g.setProperty(k,T)}else v.insertRule(`.${e} { ${m} }`,v.cssRules.length)}else{const f=c.sheet;if(!f)return;let S=null,b=0;const v=h=>h instanceof CSSMediaRule||h instanceof CSSContainerRule||h instanceof CSSSupportsRule,u=f.cssRules,x=u.length;for(let h=0;x>h;h++){const g=u[h];if(g instanceof CSSStyleRule&&g.selectorText==="."+e){S=g,b=h;break}v(g)||(b=h+1)}if(S){const h=S.style;h.cssText="";for(const[g,k]of Object.entries(r))h.setProperty(g,k)}else f.insertRule(`.${e} { ${m} }`,b)}}function Ht(e,r){V(e,r)}class j{styles={};getStyles(){return{...this.styles}}getClassName(r="",i){return(function(s,l="",c){const m=Ne(s),f=l?`${l}:${m}`:m,S=(function(u){return _e.get(u)})(f);if(S){const u=S;return(function(x,h,g="media"){const k=document.querySelector("#nuclo-styles");if(!k||!k.sheet)return!1;if(h){const T=Array.from(k.sheet.cssRules||[]).find(N=>g==="media"&&N instanceof CSSMediaRule?N.media.mediaText===h:(g==="container"&&N instanceof CSSContainerRule||g==="supports"&&N instanceof CSSSupportsRule)&&N.conditionText===h);return!!T&&Array.from(T.cssRules).some(N=>N instanceof CSSStyleRule&&N.selectorText==="."+x)}return Array.from(k.sheet.cssRules||[]).some(T=>T instanceof CSSStyleRule&&T.selectorText==="."+x)})(u,c)||V(u,s,c),u}const b=dt(m),v=l?`n${l}-${b}`:"n"+b;return(function(u,x){_e.set(u,x)})(f,v),V(v,s,c),v})(this.styles,r,i)}getClassNames(){return[this.getClassName()]}getClassDefinitions(){return Object.entries(this.styles).map(([r,i])=>({className:this.getClassName(),property:r,value:i}))}toString(){return this.getClassName()}add(r,i){return this.styles[r]=i,this}bold(){return this.styles["font-weight"]="bold",this}center(){return this.styles["justify-content"]="center",this.styles["align-items"]="center",this}flex(r){return r!==void 0?this.styles.flex=r:this.styles.display="flex",this}}function jt(e){return e.isShorthand?()=>new j().add(e.cssProperty,e.defaultValue||""):r=>new j().add(e.cssProperty,r||"")}(function(){const e=j.prototype;for(const r of lt)r.name in e||(e[r.name]=r.isShorthand?function(){return this.add(r.cssProperty,r.defaultValue||""),this}:function(i){return this.add(r.cssProperty,i),this})})();const de={};for(const e of lt)de[e.name]=jt(e);for(const e of Ft)e==="bold"||e==="center"?de[e]=()=>new j()[e]():e==="flex"&&(de[e]=r=>new j().flex(r));const{display:Ot,flex:Ut,grid:Gt,bg:Qt,color:qt,accentColor:Vt,fontSize:_t,fontWeight:Yt,fontFamily:Jt,lineHeight:Kt,letterSpacing:Xt,textAlign:Zt,textDecoration:eo,bold:to,fontStyle:oo,fontVariant:ro,fontStretch:no,textTransform:io,textIndent:ao,textOverflow:so,textShadow:lo,whiteSpace:co,wordSpacing:po,wordWrap:uo,overflowWrap:mo,textAlignLast:go,textJustify:ho,textDecorationLine:fo,textDecorationColor:yo,textDecorationStyle:bo,textDecorationThickness:xo,textUnderlineOffset:vo,verticalAlign:So,position:ko,padding:wo,paddingTop:Co,paddingRight:Po,paddingBottom:To,paddingLeft:Bo,margin:Ro,marginTop:zo,marginRight:Ao,marginBottom:Io,marginLeft:No,width:Eo,height:Mo,minWidth:Wo,maxWidth:$o,minHeight:Do,maxHeight:Lo,boxSizing:Fo,top:Ho,right:jo,bottom:Oo,left:Uo,zIndex:Go,flexDirection:Qo,alignItems:qo,justifyContent:Vo,center:_o,gap:Yo,flexWrap:Jo,flexGrow:Ko,flexShrink:Xo,flexBasis:Zo,alignSelf:er,alignContent:tr,justifySelf:or,justifyItems:rr,gridTemplateColumns:nr,gridTemplateRows:ir,gridTemplateAreas:ar,gridColumn:sr,gridRow:lr,gridColumnStart:dr,gridColumnEnd:cr,gridRowStart:pr,gridRowEnd:ur,gridArea:mr,gridAutoColumns:gr,gridAutoRows:hr,gridAutoFlow:fr,border:yr,borderTop:br,borderRight:xr,borderBottom:vr,borderLeft:Sr,borderWidth:kr,borderStyle:wr,borderColor:Cr,borderTopWidth:Pr,borderRightWidth:Tr,borderBottomWidth:Br,borderLeftWidth:Rr,borderTopStyle:zr,borderRightStyle:Ar,borderBottomStyle:Ir,borderLeftStyle:Nr,borderTopColor:Er,borderRightColor:Mr,borderBottomColor:Wr,borderLeftColor:$r,borderRadius:Dr,borderTopLeftRadius:Lr,borderTopRightRadius:Fr,borderBottomLeftRadius:Hr,borderBottomRightRadius:jr,outline:Or,outlineWidth:Ur,outlineStyle:Gr,outlineColor:Qr,outlineOffset:qr,backgroundColor:Vr,backgroundImage:_r,backgroundRepeat:Yr,backgroundPosition:Jr,backgroundSize:Kr,backgroundAttachment:Xr,backgroundClip:Zr,backgroundOrigin:en,boxShadow:tn,opacity:rn,transition:nn,transitionProperty:an,transitionDuration:sn,transitionTimingFunction:ln,transitionDelay:dn,transform:cn,transformOrigin:pn,transformStyle:un,perspective:mn,perspectiveOrigin:gn,backfaceVisibility:hn,animation:fn,animationName:yn,animationDuration:bn,animationTimingFunction:xn,animationDelay:vn,animationIterationCount:Sn,animationDirection:kn,animationFillMode:wn,animationPlayState:Cn,filter:Pn,backdropFilter:Tn,overflow:Bn,overflowX:Rn,overflowY:zn,visibility:An,objectFit:In,objectPosition:Nn,listStyle:En,listStyleType:Mn,listStylePosition:Wn,listStyleImage:$n,borderCollapse:Dn,borderSpacing:Ln,captionSide:Fn,emptyCells:Hn,tableLayout:jn,content:On,quotes:Un,counterReset:Gn,counterIncrement:Qn,appearance:qn,userSelect:Vn,pointerEvents:_n,resize:Yn,scrollBehavior:Jn,clip:Kn,clipPath:Xn,isolation:Zn,mixBlendMode:ei,willChange:ti,contain:oi,pageBreakBefore:ri,pageBreakAfter:ni,pageBreakInside:ii,breakBefore:ai,breakAfter:si,breakInside:di,orphans:ci,widows:pi,columnCount:ui,columnFill:mi,columnGap:gi,columnRule:hi,columnRuleColor:fi,columnRuleStyle:yi,columnRuleWidth:bi,columnSpan:xi,columnWidth:vi,columns:Si,cursor:ki}=de,ct={hover:":hover",active:":active",focus:":focus","focus-visible":":focus-visible","focus-within":":focus-within",visited:":visited",link:":link",target:":target",root:":root",empty:":empty",enabled:":enabled",disabled:":disabled",checked:":checked",indeterminate:":indeterminate",default:":default",required:":required",optional:":optional",valid:":valid",invalid:":invalid","in-range":":in-range","out-of-range":":out-of-range","placeholder-shown":":placeholder-shown",autofill:":autofill","read-only":":read-only","read-write":":read-write","first-child":":first-child","last-child":":last-child","only-child":":only-child","first-of-type":":first-of-type","last-of-type":":last-of-type","only-of-type":":only-of-type","nth-child":":nth-child","nth-last-child":":nth-last-child","nth-of-type":":nth-of-type","nth-last-of-type":":nth-last-of-type",lang:":lang",dir:":dir",not:":not",is:":is",where:":where",has:":has","any-link":":any-link","local-link":":local-link",scope:":scope",current:":current",past:":past",future:":future",playing:":playing",paused:":paused",seeking:":seeking",muted:":muted","volume-locked":":volume-locked",buffering:":buffering",stalled:":stalled","picture-in-picture":":picture-in-picture",fullscreen:":fullscreen",modal:":modal","popover-open":":popover-open","user-invalid":":user-invalid","user-valid":":user-valid"};function wi(e){const r=e.trim();return r.startsWith("&:")||r.startsWith(":")?{type:"pseudo",pseudoClass:(r.startsWith("&:")?r.slice(1):r).trim()}:r.startsWith("@media ")?{type:"media",condition:r.slice(7).trim()}:r.startsWith("@container ")?{type:"container",condition:r.slice(11).trim()}:r.startsWith("@supports ")?{type:"supports",condition:r.slice(10).trim()}:r.startsWith("@style ")?{type:"style",condition:r.slice(7).trim()}:{type:"media",condition:r}}function Ci(e){return e in ct}function Pi(e){return ct[e]}const Ye=new Map;function pt(e){const r=Array.isArray(e)?e:Object.entries(e),i=new Map;for(const[s,l]of r){let c=Ye.get(l);c||(c=wi(l),Ye.set(l,c)),i.set(s,c)}return function(s,l){let c,m;if(l!==void 0?(c=s,m=l):s instanceof j?(c=s,m=void 0):(c=void 0,m=s),!(c||m&&Object.keys(m).length!==0))return{className:""};if(m&&Object.keys(m).length>0){const f=[],S=new Set;for(const[k]of r){const T=m[k];T&&(S.add(k),f.push({queryName:k,query:i.get(k),styles:T.getStyles()}))}for(const[k,T]of Object.entries(m))!S.has(k)&&Ci(k)&&T instanceof j&&f.push({queryName:k,query:{type:"pseudo",pseudoClass:Pi(k)},styles:T.getStyles()});const b=[];b.length=f.length+(c?1:0);let v=0;if(c){const k=c.getStyles();b[v++]="default:"+Ne(k)}for(const{queryName:k,styles:T}of f){const N=Ne(T);b[v++]=`${k}:${N}`}const u="n"+dt(b.sort().join("||"));let x={};c&&(x={...c.getStyles()},V(u,x));const h=[],g=[];for(const k of f)k.query.type==="pseudo"?g.push(k):h.push(k);for(const{query:k,styles:T}of h)x={...x,...T},V(u,x,k.condition,k.type);for(const{query:k,styles:T}of g)k.type==="pseudo"&&V(u,T,void 0,"pseudo",k.pseudoClass);return{className:u}}return c?{className:c.getClassName()}:{className:""}}}const Ti=pt;var Bi=Object.freeze({__proto__:null,StyleBuilder:j,accentColor:Vt,alignContent:tr,alignItems:qo,alignSelf:er,animation:fn,animationDelay:vn,animationDirection:kn,animationDuration:bn,animationFillMode:wn,animationIterationCount:Sn,animationName:yn,animationPlayState:Cn,animationTimingFunction:xn,appearance:qn,backdropFilter:Tn,backfaceVisibility:hn,backgroundAttachment:Xr,backgroundClip:Zr,backgroundColor:Vr,backgroundImage:_r,backgroundOrigin:en,backgroundPosition:Jr,backgroundRepeat:Yr,backgroundSize:Kr,bg:Qt,bold:to,border:yr,borderBottom:vr,borderBottomColor:Wr,borderBottomLeftRadius:Hr,borderBottomRightRadius:jr,borderBottomStyle:Ir,borderBottomWidth:Br,borderCollapse:Dn,borderColor:Cr,borderLeft:Sr,borderLeftColor:$r,borderLeftStyle:Nr,borderLeftWidth:Rr,borderRadius:Dr,borderRight:xr,borderRightColor:Mr,borderRightStyle:Ar,borderRightWidth:Tr,borderSpacing:Ln,borderStyle:wr,borderTop:br,borderTopColor:Er,borderTopLeftRadius:Lr,borderTopRightRadius:Fr,borderTopStyle:zr,borderTopWidth:Pr,borderWidth:kr,bottom:Oo,boxShadow:tn,boxSizing:Fo,breakAfter:si,breakBefore:ai,breakInside:di,captionSide:Fn,center:_o,clip:Kn,clipPath:Xn,color:qt,columnCount:ui,columnFill:mi,columnGap:gi,columnRule:hi,columnRuleColor:fi,columnRuleStyle:yi,columnRuleWidth:bi,columnSpan:xi,columnWidth:vi,columns:Si,contain:oi,content:On,counterIncrement:Qn,counterReset:Gn,createBreakpoints:Ti,createCSSClass:Ht,createStyleQueries:pt,cursor:ki,display:Ot,emptyCells:Hn,filter:Pn,flex:Ut,flexBasis:Zo,flexDirection:Qo,flexGrow:Ko,flexShrink:Xo,flexWrap:Jo,fontFamily:Jt,fontSize:_t,fontStretch:no,fontStyle:oo,fontVariant:ro,fontWeight:Yt,gap:Yo,grid:Gt,gridArea:mr,gridAutoColumns:gr,gridAutoFlow:fr,gridAutoRows:hr,gridColumn:sr,gridColumnEnd:cr,gridColumnStart:dr,gridRow:lr,gridRowEnd:ur,gridRowStart:pr,gridTemplateAreas:ar,gridTemplateColumns:nr,gridTemplateRows:ir,height:Mo,isolation:Zn,justifyContent:Vo,justifyItems:rr,justifySelf:or,left:Uo,letterSpacing:Xt,lineHeight:Kt,listStyle:En,listStyleImage:$n,listStylePosition:Wn,listStyleType:Mn,margin:Ro,marginBottom:Io,marginLeft:No,marginRight:Ao,marginTop:zo,maxHeight:Lo,maxWidth:$o,minHeight:Do,minWidth:Wo,mixBlendMode:ei,objectFit:In,objectPosition:Nn,opacity:rn,orphans:ci,outline:Or,outlineColor:Qr,outlineOffset:qr,outlineStyle:Gr,outlineWidth:Ur,overflow:Bn,overflowWrap:mo,overflowX:Rn,overflowY:zn,padding:wo,paddingBottom:To,paddingLeft:Bo,paddingRight:Po,paddingTop:Co,pageBreakAfter:ni,pageBreakBefore:ri,pageBreakInside:ii,perspective:mn,perspectiveOrigin:gn,pointerEvents:_n,position:ko,quotes:Un,resize:Yn,right:jo,scrollBehavior:Jn,tableLayout:jn,textAlign:Zt,textAlignLast:go,textDecoration:eo,textDecorationColor:yo,textDecorationLine:fo,textDecorationStyle:bo,textDecorationThickness:xo,textIndent:ao,textJustify:ho,textOverflow:so,textShadow:lo,textTransform:io,textUnderlineOffset:vo,top:Ho,transform:cn,transformOrigin:pn,transformStyle:un,transition:nn,transitionDelay:dn,transitionDuration:sn,transitionProperty:an,transitionTimingFunction:ln,userSelect:Vn,verticalAlign:So,visibility:An,whiteSpace:co,widows:pi,width:Eo,willChange:ti,wordSpacing:po,wordWrap:uo,zIndex:Go});function Ri(){if(Bt(),typeof globalThis<"u"){const e=globalThis;e.list=At,e.update=$t,e.when=Mt,e.on=Dt,e.render=Lt;for(const[r,i]of Object.entries(Bi))try{e[r]=i}catch{}}}typeof globalThis<"u"&&Ri();const o={primary:"#84cc16",primaryHover:"#a3e635",primaryDark:"#65a30d",primaryGlow:"rgba(132, 204, 22, 0.3)",bg:"#0a0f1a",bgLight:"#111827",bgCard:"#1a2332",bgCode:"#0d1117",text:"#f8fafc",textMuted:"#94a3b8",textDim:"#64748b",accent:"#84cc16",border:"#1e293b",borderLight:"#334155",codeKeyword:"#c792ea",codeString:"#c3e88d",codeFunction:"#82aaff",codeComment:"#676e95",codeNumber:"#f78c6c"};function zi(){const e=document.createElement("style");e.textContent=`
  ...
  `,document.head.appendChild(e)}const n=createStyleQueries({small:"@media (min-width: 341px)",medium:"@media (min-width: 601px)",large:"@media (min-width: 1025px)"}),t={container:n(padding("0 16px").maxWidth("1200px").margin("0 auto").width("100%").boxSizing("border-box"),{medium:padding("0 24px")}),header:n(display("flex").backgroundColor("#FF0000").alignItems("center").justifyContent("space-between").padding("20px 24px").backgroundColor("transparent").containerType("inline-size").position("fixed").top("0").left("0").right("0").zIndex(100).borderBottom(`1px solid ${o.border}`),{medium:padding("20px 48px")}),logo:n(display("flex").alignItems("center").gap("12px").fontSize("20px").fontWeight("700").color(o.primary).transition("opacity 0.2s"),{medium:fontSize("24px")}),nav:n(display("flex").alignItems("center").gap("8px").width("100%").height("200px")),navLink:n(color(o.textMuted).fontSize("14px").fontWeight("500").transition("all 0.2s"),{medium:fontSize("15px"),hover:color("red")}),navLinkActive:n(color(o.text)),hero:n(padding("60px 24px 80px").textAlign("center").maxWidth("1000px").margin("0 auto").position("relative"),{medium:padding("100px 48px 120px")}),heroTitle:n(fontSize("40px").fontWeight("700").lineHeight("1.1").marginBottom("24px").color(o.text).letterSpacing("-0.02em"),{medium:fontSize("56px"),large:fontSize("64px")}),heroTitleAccent:n(color(o.primary)),heroTitleAccentStyle:{fontStyle:"italic"},heroSubtitle:n(fontSize("16px").color(o.textMuted).maxWidth("600px").margin("0 auto 48px").lineHeight("1.7"),{medium:fontSize("18px"),large:fontSize("20px")}),heroButtons:n(display("flex").gap("16px").justifyContent("center").flexWrap("wrap")),btnPrimary:n(padding("14px 32px").backgroundColor(o.primary).color(o.bg).borderRadius("8px").fontWeight("600").fontSize("15px").border("none").transition("all 0.2s")),btnPrimaryStyle:{boxShadow:`0 0 20px ${o.primaryGlow}`},btnSecondary:n(padding("14px 32px").backgroundColor("transparent").color(o.text).borderRadius("8px").fontWeight("600").fontSize("15px").border(`1px solid ${o.borderLight}`).transition("all 0.2s")),features:n(display("grid").gap("24px").padding("60px 24px").maxWidth("1200px").margin("0 auto"),{medium:padding("80px 48px")}),featuresStyle:{gridTemplateColumns:"repeat(auto-fit, minmax(320px, 1fr))"},featureCard:n(padding("32px").backgroundColor(o.bgCard).borderRadius("16px").border(`1px solid ${o.border}`).transition("all 0.3s").position("relative").overflow("hidden")),featureIcon:n(width("56px").height("56px").borderRadius("12px").display("flex").alignItems("center").justifyContent("center").marginBottom("20px").fontSize("28px")),featureIconStyle:{background:`linear-gradient(135deg, ${o.bgLight} 0%, ${o.bgCard} 100%)`,border:`1px solid ${o.border}`},featureTitle:n(fontSize("20px").fontWeight("600").marginBottom("12px").color(o.text)),featureDesc:n(fontSize("15px").color(o.textMuted).lineHeight("1.7")),codeBlock:n(backgroundColor(o.bgCode).borderRadius("12px").padding("16px").overflow("auto").maxWidth("100%").boxSizing("border-box").border(`1px solid ${o.border}`).fontSize("14px").lineHeight("1.7"),{medium:padding("24px")}),codeInline:n(backgroundColor(o.bgLight).padding("3px 8px").borderRadius("6px").fontSize("14px").color(o.primary).border(`1px solid ${o.border}`)),section:n(padding("60px 24px").maxWidth("1200px").margin("0 auto"),{medium:padding("100px 48px")}),sectionTitle:n(fontSize("28px").fontWeight("700").marginBottom("16px").color(o.text).letterSpacing("-0.02em"),{medium:fontSize("36px"),large:fontSize("40px")}),sectionSubtitle:n(fontSize("18px").color(o.textMuted).marginBottom("56px").maxWidth("600px").lineHeight("1.7")),demoContainer:n(display("grid").gap("16px").gridTemplateColumns("1fr").width("100%").boxSizing("border-box"),{medium:gap("24px").gridTemplateColumns("1fr 1fr")}),demoContainerSingle:n(display("flex").flexDirection("column").gap("16px").width("100%").boxSizing("border-box"),{medium:gap("24px")}),demoPanel:n(backgroundColor(o.bgCard).borderRadius("16px").border(`1px solid ${o.border}`).overflow("hidden").maxWidth("100%").boxSizing("border-box")),demoPanelHeader:n(padding("14px 20px").backgroundColor(o.bgLight).borderBottom(`1px solid ${o.border}`).fontSize("13px").fontWeight("600").color(o.textMuted).textTransform("uppercase").letterSpacing("0.05em")),demoPanelContent:n(padding("16px"),{medium:padding("24px")}),footer:n(padding("48px").borderTop(`1px solid ${o.border}`).marginTop("auto").textAlign("center").backgroundColor(o.bgLight)),footerText:n(fontSize("14px").color(o.textDim)),footerLink:n(color(o.textMuted).transition("color 0.2s")),pageContent:n(padding("24px 16px 80px").maxWidth("900px").margin("0 auto").width("100%").boxSizing("border-box"),{medium:padding("48px 48px 80px")}),pageTitle:n(fontSize("32px").fontWeight("700").marginBottom("24px").color(o.text).letterSpacing("-0.02em"),{medium:fontSize("40px"),large:fontSize("48px")}),pageSubtitle:n(fontSize("20px").color(o.textMuted).marginBottom("56px").lineHeight("1.7")),h2:n(fontSize("32px").fontWeight("600").marginTop("64px").marginBottom("20px").color(o.text).letterSpacing("-0.01em")),h3:n(fontSize("22px").fontWeight("600").marginTop("40px").marginBottom("16px").color(o.text)),p:n(fontSize("16px").color(o.textMuted).marginBottom("20px").lineHeight("1.8")),ul:n(paddingLeft("24px").marginBottom("20px")),li:n(fontSize("16px").color(o.textMuted).marginBottom("12px").lineHeight("1.7")),flex:n(display("flex")),flexCenter:n(display("flex").alignItems("center").justifyContent("center")),flexBetween:n(display("flex").alignItems("center").justifyContent("space-between")),flexCol:n(display("flex").flexDirection("column")),gap8:n(gap("8px")),gap16:n(gap("16px")),gap24:n(gap("24px")),gap32:n(gap("32px")),mt16:n(marginTop("16px")),mt24:n(marginTop("24px")),mt32:n(marginTop("32px")),mb16:n(marginBottom("16px")),mb24:n(marginBottom("24px")),table:n(width("100%").borderCollapse("collapse").marginBottom("24px").fontSize("14px")),th:n(padding("14px 16px").textAlign("left").borderBottom(`2px solid ${o.border}`).fontWeight("600").color(o.text).backgroundColor(o.bgLight)),td:n(padding("14px 16px").borderBottom(`1px solid ${o.border}`).color(o.textMuted)),glowBoxStyle:{boxShadow:`0 0 60px ${o.primaryGlow}, inset 0 0 60px rgba(132, 204, 22, 0.05)`}},Je={home:{title:"Nuclo - Simple Reactive DOM Library",description:"A simple, explicit DOM library for building reactive user interfaces. Lightweight, type-safe, and easy to learn - build modern web apps without the complexity.",keywords:"nuclo, reactive, DOM library, javascript, typescript, ui framework"},"getting-started":{title:"Getting Started - Nuclo",description:"Learn how to get started with Nuclo. Installation guide, basic concepts, and your first reactive application.",keywords:"nuclo tutorial, getting started, installation, setup, quick start"},"core-api":{title:"Core API - Nuclo",description:"Explore Nuclo's core API including state management, reactive updates, and DOM manipulation utilities.",keywords:"nuclo api, core api, state management, reactive state"},"tag-builders":{title:"Tag Builders - Nuclo",description:"Learn about Nuclo's tag builder functions for creating DOM elements with a clean, functional API.",keywords:"tag builders, dom creation, elements, nuclo tags"},styling:{title:"Styling - Nuclo",description:"Discover how to style your Nuclo applications with inline styles, CSS-in-JS, and external stylesheets.",keywords:"nuclo styling, css, inline styles, css-in-js"},pitfalls:{title:"Common Pitfalls - Nuclo",description:"Avoid common mistakes when working with Nuclo. Best practices and troubleshooting guide.",keywords:"nuclo pitfalls, common mistakes, best practices, troubleshooting"},examples:{title:"Examples - Nuclo",description:"Browse interactive examples showcasing Nuclo's capabilities - from simple counters to complex applications.",keywords:"nuclo examples, demos, sample code, tutorials"},"example-counter":{title:"Counter Example - Nuclo",description:"A simple counter example demonstrating Nuclo's reactive state management.",keywords:"counter example, reactive state, nuclo tutorial"},"example-todo":{title:"Todo App Example - Nuclo",description:"Build a todo application with Nuclo. Learn about state, events, and list rendering.",keywords:"todo app, nuclo example, list rendering"},"example-subtasks":{title:"Subtasks Example - Nuclo",description:"Advanced todo example with nested subtasks demonstrating complex state management.",keywords:"subtasks, nested state, complex example"},"example-search":{title:"Search Example - Nuclo",description:"Implement a search interface with filtering using Nuclo's reactive state.",keywords:"search, filtering, reactive search"},"example-async":{title:"Async Data Example - Nuclo",description:"Handle asynchronous data fetching and loading states in Nuclo applications.",keywords:"async, data fetching, loading states, promises"},"example-forms":{title:"Forms Example - Nuclo",description:"Create interactive forms with validation using Nuclo.",keywords:"forms, validation, input handling"},"example-nested":{title:"Nested Components Example - Nuclo",description:"Learn how to compose and nest components in Nuclo applications.",keywords:"components, composition, nested components"},"example-animations":{title:"Animations Example - Nuclo",description:"Add smooth animations and transitions to your Nuclo applications.",keywords:"animations, transitions, effects"},"example-routing":{title:"Routing Example - Nuclo",description:"Implement client-side routing in Nuclo applications.",keywords:"routing, navigation, spa"},"example-styled-card":{title:"Styled Card Example - Nuclo",description:"Create beautiful styled components with Nuclo's styling capabilities.",keywords:"styled components, css, card design"}};function Ee(e){const r=Je[e]||Je.home,i="https://nuclo.dan2.dev/",s=e==="home"?i:`${i}${e}`;document.title=r.title,E("name","title",r.title),E("name","description",r.description),r.keywords&&E("name","keywords",r.keywords),E("property","og:title",r.title),E("property","og:description",r.description),E("property","og:url",s),E("name","twitter:title",r.title),E("name","twitter:description",r.description),E("name","twitter:url",s),Ai("canonical",s)}function E(e,r,i){let s=document.querySelector(`meta[${e}="${r}"]`);s||(s=document.createElement("meta"),s.setAttribute(e,r),document.head.appendChild(s)),s.setAttribute("content",i)}function Ai(e,r){let i=document.querySelector(`link[rel="${e}"]`);i||(i=document.createElement("link"),i.setAttribute("rel",e),document.head.appendChild(i)),i.setAttribute("href",r)}let q="home";function R(){return q}function z(e){q=e;const r="/";if(e==="home")window.history.pushState({},"",r);else{const i=r.endsWith("/")?`${r}${e}`:`${r}/${e}`;window.history.pushState({},"",i)}window.scrollTo(0,0),Ee(e),update()}const Ke=["home","getting-started","core-api","tag-builders","styling","pitfalls","examples","example-counter","example-todo","example-subtasks","example-search","example-async","example-forms","example-nested","example-animations","example-routing","example-styled-card"];function Ii(){let i=window.location.pathname.replace("/","");i=i.replace(/^\/+|\/+$/g,"");const s=i||"home";Ke.includes(s)&&(q=s),Ee(q),window.addEventListener("popstate",()=>{let c=window.location.pathname.replace("/","");c=c.replace(/^\/+|\/+$/g,"");const m=c||"home";q=Ke.includes(m)?m:"home",Ee(q),update()})}function Ni(e=32,r=!1){return svgSvg({width:String(e),height:String(e),viewBox:"0 0 32 32",fill:"none"},i=>{if(r){const s=i;s.removeAttribute("width"),s.removeAttribute("height"),s.style.maxWidth="100%",s.style.width="100%",s.style.height="auto"}},circleSvg({cx:"16",cy:"16",r:"14",stroke:o.primary,"stroke-width":"2",fill:"none",opacity:"0.3"}),circleSvg({cx:"16",cy:"16",r:"12",stroke:o.primary,"stroke-width":"2",fill:"none"}),circleSvg({cx:"16",cy:"16",r:"5",fill:o.primary}),circleSvg({cx:"16",cy:"5",r:"2",fill:o.primaryHover}),circleSvg({cx:"24",cy:"20",r:"2",fill:o.primaryHover}),circleSvg({cx:"8",cy:"20",r:"2",fill:o.primaryHover}))}function Ei(){return svgSvg({width:"28",height:"28",viewBox:"0 0 24 24",fill:"none",stroke:o.primary,"stroke-width":"1.5","stroke-linecap":"round","stroke-linejoin":"round"},pathSvg({d:"M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"}),pathSvg({d:"m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"}),pathSvg({d:"M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"}),pathSvg({d:"M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"}))}function Mi(){return svgSvg({width:"28",height:"28",viewBox:"0 0 24 24",fill:"none",stroke:o.primary,"stroke-width":"1.5","stroke-linecap":"round","stroke-linejoin":"round"},pathSvg({d:"M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"}),pathSvg({d:"m3.3 7 8.7 5 8.7-5"}),pathSvg({d:"M12 22V12"}))}function Wi(){return svgSvg({width:"28",height:"28",viewBox:"0 0 24 24",fill:"none",stroke:o.primary,"stroke-width":"1.5","stroke-linecap":"round","stroke-linejoin":"round"},pathSvg({d:"M13 2 3 14h9l-1 8 10-12h-9l1-8z"}))}function $i(){return svgSvg({width:"28",height:"28",viewBox:"0 0 24 24",fill:"none",stroke:o.primary,"stroke-width":"1.5","stroke-linecap":"round","stroke-linejoin":"round"},pathSvg({d:"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"}),pathSvg({d:"M21 3v5h-5"}),pathSvg({d:"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"}),pathSvg({d:"M8 16H3v5"}))}function Di(){return svgSvg({width:"28",height:"28",viewBox:"0 0 24 24",fill:"none",stroke:o.primary,"stroke-width":"1.5","stroke-linecap":"round","stroke-linejoin":"round"},pathSvg({d:"m16 18 6-6-6-6"}),pathSvg({d:"m8 6-6 6 6 6"}))}function Li(){return svgSvg({width:"28",height:"28",viewBox:"0 0 24 24",fill:"none",stroke:o.primary,"stroke-width":"1.5","stroke-linecap":"round","stroke-linejoin":"round"},pathSvg({d:"m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83Z"}),pathSvg({d:"m22 12.65-9.17 4.16a2 2 0 0 1-1.66 0L2 12.65"}),pathSvg({d:"m22 17.65-9.17 4.16a2 2 0 0 1-1.66 0L2 17.65"}))}function Fi(){return svgSvg({width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},pathSvg({d:"M5 12h14"}),pathSvg({d:"m12 5 7 7-7 7"}))}function Hi(){return svgSvg({width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},pathSvg({d:"M20 6 9 17l-5-5"}))}function ji(){return svgSvg({width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},rectSvg({x:"9",y:"9",width:"13",height:"13",rx:"2",ry:"2"}),pathSvg({d:"M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"}))}function Oi(){return svgSvg({width:"20",height:"20",viewBox:"0 0 24 24",fill:"currentColor"},pathSvg({d:"M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"}))}function Ui(){return svgSvg({width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},lineSvg({x1:"3",y1:"6",x2:"21",y2:"6"}),lineSvg({x1:"3",y1:"12",x2:"21",y2:"12"}),lineSvg({x1:"3",y1:"18",x2:"21",y2:"18"}))}function Gi(){return svgSvg({width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},lineSvg({x1:"18",y1:"6",x2:"6",y2:"18"}),lineSvg({x1:"6",y1:"6",x2:"18",y2:"18"}))}let te=!1;function Qi(){te=!te,update()}function ut(){te=!1,update()}const mt=[{label:"Getting Started",route:"getting-started"},{label:"Core API",route:"core-api"},{label:"Tag Builders",route:"tag-builders"},{label:"Styling",route:"styling"},{label:"Pitfalls",route:"pitfalls"},{label:"Examples",route:"examples"}];function gt(e,r){const i=()=>R()===r||R().startsWith(r+"-");return a({href:`#${r}`},n(display("flex").alignItems("center").padding("8px 14px").borderRadius("8px").fontSize("14px").fontWeight("500").transition("all 0.2s").color(o.textMuted).cursor("pointer"),{hover:backgroundColor(o.accent).color(o.bg)}),{style:()=>({color:i()?o.primary:void 0})},e,on("click",s=>{s.preventDefault(),z(r),ut()}))}function qi(){return a({href:"/"},n(display("flex").alignItems("center").gap("10px").fontSize("18px").fontWeight("700").color(o.primary).transition("opacity 0.2s").cursor("pointer"),{hover:opacity("0.8")}),Ni(28),span("Nuclo"),on("click",e=>{e.preventDefault(),z("home"),ut()}))}function ht(){return a({href:"https://github.com/dan2dev/nuclo",target:"_blank",rel:"noopener noreferrer",ariaLabel:"GitHub"},n(display("flex").alignItems("center").justifyContent("center").width("36px").height("36px").borderRadius("8px").transition("all 0.2s").color(o.textMuted).backgroundColor("transparent"),{hover:color(o.primary).backgroundColor("rgba(132, 204, 22, 0.1)")}),Oi())}function Vi(){return button(n(display("flex").alignItems("center").justifyContent("center").width("40px").height("40px").borderRadius("8px").backgroundColor("transparent").border("none").color(o.text).cursor("pointer").transition("all 0.2s"),{medium:display("none")}),when(()=>te,Gi()).else(Ui()),on("click",Qi))}function _i(){return when(()=>te,div(n(position("fixed").top("64px").left("0").right("0").backgroundColor(o.bg).borderBottom(`1px solid ${o.border}`).padding("16px 24px").zIndex(99).display("flex").flexDirection("column").gap("8px")),{style:{backdropFilter:"blur(12px)",background:"rgba(10, 15, 26, 0.95)"}},...mt.map(e=>gt(e.label,e.route)),div(n(display("flex").alignItems("center").gap("8px").padding("8px 14px")),ht(),span(n(color(o.textMuted).fontSize("14px")),"GitHub"))))}function Yi(){const e=n(position("fixed").top("0").left("0").right("0").zIndex(100).borderBottom(`1px solid ${o.border}`)),r=n(display("flex").alignItems("center").justifyContent("space-between").maxWidth("1400px").margin("0 auto").padding("12px 24px"),{medium:padding("16px 48px")}),i=n(display("none").alignItems("center").gap("4px"),{medium:display("flex")}),s=n(display("flex").alignItems("center").gap("8px"));return div(header(e,{style:{backdropFilter:"blur(12px)",background:"rgba(10, 15, 26, 0.85)"}},div(r,qi(),nav(i,...mt.map(l=>gt(l.label,l.route))),div(s,div(n(display("none"),{medium:display("flex")}),ht()),Vi()))),_i())}function Ji(){return footer(t.footer,div(t.footerText,"Created by ",a({href:"https://github.com/dan2dev",target:"_blank",rel:"noopener noreferrer"},n(color(o.textMuted).transition("color 0.2s"),{hover:color(o.primary)}),"Danilo Celestino de Castro")," · MIT License · ",a({href:"https://github.com/dan2dev/nuclo",target:"_blank",rel:"noopener noreferrer"},n(color(o.textMuted).transition("color 0.2s"),{hover:color(o.primary)}),"GitHub")))}let ft={};function Xe(e,r){ft[e]=r,update()}function Ze(e){return ft[e]||!1}function Ki(e){return e.replace(/(["'`])(?:(?!\1)[^\\]|\\.)*\1/g,`<span style="color: ${o.codeString}">$&</span>`).replace(/(\/\/.*$)/gm,`<span style="color: ${o.codeComment}">$1</span>`).replace(/\b(import|export|from|const|let|var|function|return|if|else|for|while|type|interface|async|await|new|class|extends|implements|public|private|protected|static|readonly|typeof|keyof|in|of|true|false|null|undefined|this)\b/g,`<span style="color: ${o.codeKeyword}">$1</span>`).replace(/\b([a-zA-Z_][a-zA-Z0-9_]*)\s*\(/g,`<span style="color: ${o.codeFunction}">$1</span>(`).replace(/\b(\d+\.?\d*)\b/g,`<span style="color: ${o.codeNumber}">$1</span>`).replace(/:\s*([A-Z][a-zA-Z0-9_]*)/g,`: <span style="color: ${o.codeKeyword}">$1</span>`)}function d(e,r="typescript",i=!0){const s=`code-${Math.random().toString(36).slice(2,9)}`,l=Ki(e.trim());return div(n(position("relative").width("100%").maxWidth("100%").boxSizing("border-box")),pre(t.codeBlock,code(n(display("block").width("100%").maxWidth("100%").whiteSpace("pre").overflowX("auto")),{innerHTML:l})),i?button(n(position("absolute").top("12px").right("12px").padding("6px 10px").borderRadius("6px").color(o.textMuted).fontSize("12px").cursor("pointer").display("flex").alignItems("center").gap("4px").transition("all 0.2s").backgroundColor(o.bgLight).border(`1px solid ${o.border}`),{hover:border(`1px solid ${o.borderLight}`).color(o.text)}),()=>Ze(s)?Hi():ji(),()=>Ze(s)?"Copied!":"Copy",on("click",async()=>{await navigator.clipboard.writeText(e.trim()),Xe(s,!0),setTimeout(()=>Xe(s,!1),2e3)})):null)}function P(e){return code(t.codeInline,e)}const I=[{id:"counter",title:"Counter",description:"The classic counter example showing basic state management and event handling.",code:`import 'nuclo';
...
render(app, document.body);`}},Xi=`import 'nuclo';
...
render(counter, document.body);`;let Y=0;function Zi(){return div(n(display("flex").flexDirection("column").gap("12px").padding("24px").backgroundColor(o.bgCard).border(`1px solid ${o.border}`).borderRadius("12px")),h3(n(fontSize("16px").fontWeight("600").color(o.text)),"Live Counter Demo"),div(n(display("flex").alignItems("center").gap("12px")),span(n(fontSize("32px").fontWeight("700").color(o.text)),()=>Y),span(n(color(o.textDim)),()=>Y%2===0?"even":"odd")),div(n(display("flex").gap("8px")),button(t.btnSecondary,"-",on("click",()=>{Y--,update()})),button(t.btnSecondary,"Reset",on("click",()=>{Y=0,update()})),button(t.btnPrimary,{style:t.btnPrimaryStyle},"+",on("click",()=>{Y++,update()}))))}function Q(e,r,i){const s=n(padding("32px").backgroundColor(o.bgCard).borderRadius("16px").border(`1px solid ${o.border}`).transition("all 0.3s").position("relative").overflow("hidden"));return div(s,div(t.featureIcon,{style:t.featureIconStyle},e),h3(t.featureTitle,r),p(t.featureDesc,i))}const ea=["counter","todo","search","async","styled-card","subtasks"],ta=I.filter(e=>ea.includes(e.id));function oa(e){z("examples"),setTimeout(()=>{const r=document.getElementById(e);r&&r.scrollIntoView({behavior:"smooth",block:"start"})},150)}function ra(){return div(section(t.hero,h1(t.heroTitle,"Build ",span(t.heroTitleAccent,{style:t.heroTitleAccentStyle},"Faster"),", ",span(t.heroTitleAccent,{style:t.heroTitleAccentStyle},"Reactive")," Interfaces."),p(t.heroSubtitle,"A lightweight, flexible, component-based framework for the modern web. Just functions, plain objects, and explicit updates."),div(t.heroButtons,button(n(padding("14px 32px").backgroundColor(o.primary).color(o.bg).borderRadius("8px").fontWeight("600").fontSize("15px").border("none").transition("all 0.2s").display("flex").alignItems("center").gap("8px"),{hover:backgroundColor(o.primaryHover).transform("translateY(-2px)").boxShadow(`0 0 30px ${o.primaryGlow}`)}),{style:t.btnPrimaryStyle},"Get Started",Fi(),on("click",()=>z("getting-started"))),button(n(padding("14px 32px").backgroundColor("transparent").color(o.text).borderRadius("8px").fontWeight("600").fontSize("15px").border(`1px solid ${o.borderLight}`).transition("all 0.2s"),{hover:border(`1px solid ${o.primary}`).color(o.primary).transform("translateY(-2px)")}),"View Demo",on("click",()=>z("examples"))))),section(n(padding("0 48px 100px").maxWidth("800px").margin("0 auto")),div(n(borderRadius("16px").border(`1px solid ${o.border}`).overflow("hidden")),{style:t.glowBoxStyle},div(n(padding("12px 20px").backgroundColor(o.bgLight).borderBottom(`1px solid ${o.border}`).display("flex").alignItems("center").gap("8px")),span(n(width("12px").height("12px").borderRadius("50%").backgroundColor("#ff5f57"))),span(n(width("12px").height("12px").borderRadius("50%").backgroundColor("#febc2e"))),span(n(width("12px").height("12px").borderRadius("50%").backgroundColor("#28c840"))),span(n(marginLeft("auto").fontSize("13px").color(o.textDim)),"main.ts")),d(Xi,"typescript",!1))),section(t.features,{style:t.featuresStyle},Q(Ei(),"Lightweight & Fast","Zero dependencies, tiny bundle size. Built for performance from the ground up with direct DOM manipulation."),Q(Mi(),"Component-Based","Build encapsulated components that manage their own state. Compose them to make complex UIs simple."),Q($i(),"Simple Reactivity","Explicit update() calls give you full control. No magic, no proxies, no hidden re-renders."),Q(Wi(),"Fine-Grained Updates","Only updates what changed. Elements are reused, branches are preserved, performance is maximized."),Q(Di(),"TypeScript-First","Full type definitions for 140+ HTML and SVG tags. Catch errors at compile time, not runtime."),Q(Li(),"Intuitive API","Global tag builders feel natural. Just use div(), span(), button() - no imports needed.")),section(t.section,h2(t.sectionTitle,"Quick Start"),p(t.sectionSubtitle,"Get up and running in seconds."),div(t.flexCol,t.gap32,div(h3(n(fontSize("18px").fontWeight("600").color(o.primary).marginBottom("16px")),"1. Install"),d("npm install nuclo","bash")),div(h3(n(fontSize("18px").fontWeight("600").color(o.primary).marginBottom("16px")),"2. Import and use"),d(`import 'nuclo';
...
)`,"typescript")),h2(t.h2,{id:"summary"},"Quick Reference"),div(n(padding("20px").backgroundColor(o.bgCard).borderRadius("12px").border(`1px solid ${o.border}`)),ul(t.ul,li(t.li,strong("Conditional elements:")," Use ",P("when()"),", not ",P("() => condition ? A : B")),li(t.li,strong("State changes:")," Always call ",P("update()")," after modifying state"),li(t.li,strong("Lists:")," Mutate objects, don't replace them"),li(t.li,strong("Batching:")," Group state changes before a single ",P("update()")),li(t.li,strong("Dynamic content:")," Wrap in ",P("() =>")," to make reactive"))))}const da={counter:"example-counter",todo:"example-todo",subtasks:"example-subtasks",search:"example-search",async:"example-async",forms:"example-forms",nested:"example-nested",animations:"example-animations",routing:"example-routing","styled-card":"example-styled-card"},ca=n(backgroundColor(o.bgCard).padding("24px").borderRadius("12px").border(`1px solid ${o.border}`).cursor("pointer").transition("all 0.2s"),{hover:border(`1px solid ${o.primary}`).transform("translateY(-2px)").boxShadow("0 4px 12px rgba(0, 0, 0, 0.15)")}),pa=n(fontSize("18px").fontWeight("600").color(o.text).marginBottom("8px")),ua=n(fontSize("14px").color(o.textMuted).lineHeight("1.5")),be=n(display("grid").gridTemplateColumns("repeat(auto-fill, minmax(300px, 1fr))").gap("20px").marginBottom("48px")),xe=n(fontSize("20px").fontWeight("600").color(o.text).marginBottom("20px").marginTop("32px")),ma=n(display("inline-block").padding("4px 8px").backgroundColor("rgba(132, 204, 22, 0.15)").color(o.primary).fontSize("11px").fontWeight("600").borderRadius("4px").marginLeft("8px").textTransform("uppercase"));function ve(e,r){const i=da[e.id];return div(ca,on("click",()=>z(i)),div(pa,e.title,r?span(ma,"Live Demo"):null),p(ua,e.description))}const ga=["counter","todo","subtasks"],ha=["search","async","forms"],fa=["nested","animations","routing","styled-card"];function Se(e){return I.filter(r=>e.includes(r.id))}function ya(){const e=new Set(["counter","todo","subtasks","search","async","forms","nested","animations","routing","styled-card"]);return div(t.pageContent,h1(t.pageTitle,"Examples"),p(t.pageSubtitle,"Explore practical examples demonstrating Nuclo's features. Examples with live demos are marked with a badge."),h2(xe,"Getting Started"),p(n(color(o.textMuted).marginBottom("16px")),"Simple examples to help you understand the basics."),div(be,...Se(ga).map(r=>ve(r,e.has(r.id)))),h2(xe,"Data & Forms"),p(n(color(o.textMuted).marginBottom("16px")),"Working with data, APIs, and form handling."),div(be,...Se(ha).map(r=>ve(r,e.has(r.id)))),h2(xe,"Advanced Patterns"),p(n(color(o.textMuted).marginBottom("16px")),"More complex patterns and techniques."),div(be,...Se(fa).map(r=>ve(r,e.has(r.id)))),section(n(marginTop("48px").paddingTop("32px").borderTop(`1px solid ${o.border}`)),h2(t.h2,"More Examples"),p(t.p,"Find even more demos in the ",a({href:"https://github.com/dan2dev/nuclo/tree/main/examples",target:"_blank",rel:"noopener noreferrer"},n(color(o.primary)),"GitHub examples directory"),".")))}let re=0;const ba=n(backgroundColor(o.bgCard).padding("32px").borderRadius("16px").border(`1px solid ${o.border}`).marginBottom("32px")),et=n(padding("10px 20px").backgroundColor(o.primary).color(o.bg).border("none").borderRadius("8px").fontSize("14px").fontWeight("600").cursor("pointer").transition("all 0.2s")),xa=n(padding("10px 20px").backgroundColor(o.bgLight).color(o.text).border(`1px solid ${o.border}`).borderRadius("8px").fontSize("14px").fontWeight("500").cursor("pointer").transition("all 0.2s"));function va(){return div(ba,div(t.flexBetween,div(h3(n(fontSize("48px").fontWeight("700").color(o.text).marginBottom("8px")),()=>re),p(n(fontSize("14px").color(o.textMuted)),"Current count")),div(t.flex,t.gap8,button(et,n(width("44px").height("44px").fontSize("20px").padding("0").display("flex").alignItems("center").justifyContent("center")),"−",on("click",()=>{re--,update()}),on("mouseenter",e=>{e.target.style.backgroundColor=o.primaryHover,e.target.style.transform="scale(1.05)"}),on("mouseleave",e=>{e.target.style.backgroundColor=o.primary,e.target.style.transform="scale(1)"})),button(et,n(width("44px").height("44px").fontSize("20px").padding("0").display("flex").alignItems("center").justifyContent("center")),"+",on("click",()=>{re++,update()}),on("mouseenter",e=>{e.target.style.backgroundColor=o.primaryHover,e.target.style.transform="scale(1.05)"}),on("mouseleave",e=>{e.target.style.backgroundColor=o.primary,e.target.style.transform="scale(1)"})),button(xa,"Reset",on("click",()=>{re=0,update()}),on("mouseenter",e=>{e.target.style.borderColor=o.primary}),on("mouseleave",e=>{e.target.style.borderColor=o.border})))))}function Sa(){const e=I.find(r=>r.id==="counter");return div(t.pageContent,a(n(color(o.textMuted).fontSize("14px").marginBottom("16px").display("inline-block").cursor("pointer")),"← Back to Examples",on("click",r=>{r.preventDefault(),z("examples")})),h1(t.pageTitle,e.title),p(t.pageSubtitle,e.description),va(),h2(t.h2,"Source Code"),d(e.code,"typescript"))}let W=[{id:1,text:"Learn Nuclo",done:!0},{id:2,text:"Build something awesome",done:!1},{id:3,text:"Share with friends",done:!1}],$="",tt=4;const ka=n(backgroundColor(o.bgCard).padding("32px").borderRadius("16px").border(`1px solid ${o.border}`).marginBottom("32px")),wa=n(padding("10px 20px").backgroundColor(o.primary).color(o.bg).border("none").borderRadius("8px").fontSize("14px").fontWeight("600").cursor("pointer").transition("all 0.2s")),Ca=n(padding("10px 14px").backgroundColor(o.bgLight).color(o.text).border(`1px solid ${o.border}`).borderRadius("8px").fontSize("14px").outline("none").width("220px").transition("border-color 0.2s"));function Pa(){const e=n(width("20px").height("20px").cursor("pointer")),r={accentColor:o.primary},i=n(display("flex").alignItems("center").gap("14px").padding("14px 16px").backgroundColor(o.bgLight).borderRadius("10px").marginBottom("10px").transition("all 0.2s")),s=n(marginLeft("auto").padding("6px 10px").backgroundColor("transparent").color(o.textDim).border("none").borderRadius("6px").cursor("pointer").fontSize("18px").transition("all 0.2s"));return div(ka,div(t.flex,t.gap8,t.mb24,input(Ca,{type:"text",placeholder:"Add a new task...",value:()=>$},on("input",l=>{$=l.target.value,update()}),on("keydown",l=>{l.key==="Enter"&&$.trim()&&(W.push({id:tt++,text:$,done:!1}),$="",update())}),on("focus",l=>{l.target.style.borderColor=o.primary}),on("blur",l=>{l.target.style.borderColor=o.border})),button(wa,"Add Task",on("click",()=>{$.trim()&&(W.push({id:tt++,text:$,done:!1}),$="",update())}),on("mouseenter",l=>{l.target.style.backgroundColor=o.primaryHover}),on("mouseleave",l=>{l.target.style.backgroundColor=o.primary}))),div(()=>`${W.filter(l=>!l.done).length} remaining · ${W.filter(l=>l.done).length} completed`,n(fontSize("13px").color(o.textDim).marginBottom("20px").fontWeight("500"))),when(()=>W.length>0,list(()=>W,l=>div(i,input(e,{style:r},{type:"checkbox",checked:()=>l.done},on("change",()=>{l.done=!l.done,update()})),span(()=>l.done?n(color(o.textDim).textDecoration("line-through").fontSize("15px")):n(color(o.text).fontSize("15px")),()=>l.text),button(s,"×",on("click",()=>{W=W.filter(c=>c.id!==l.id),update()}),on("mouseenter",c=>{c.target.style.backgroundColor="rgba(239, 68, 68, 0.1)",c.target.style.color="#ef4444"}),on("mouseleave",c=>{c.target.style.backgroundColor="transparent",c.target.style.color=o.textDim}))))).else(p(n(color(o.textDim).textAlign("center").padding("32px").fontSize("15px")),"No tasks yet. Add one above!")))}function Ta(){const e=I.find(r=>r.id==="todo");return div(t.pageContent,a(n(color(o.textMuted).fontSize("14px").marginBottom("16px").display("inline-block").cursor("pointer")),"← Back to Examples",on("click",r=>{r.preventDefault(),z("examples")})),h1(t.pageTitle,e.title),p(t.pageSubtitle,e.description),Pa(),h2(t.h2,"Source Code"),d(e.code,"typescript"))}let oe=[{id:1,text:"Learn Nuclo basics",done:!0,expanded:!0,subtasks:[{id:2,text:"Read documentation",done:!0,expanded:!0,subtasks:[]},{id:3,text:"Try examples",done:!1,expanded:!0,subtasks:[]}]},{id:4,text:"Build a project",done:!1,expanded:!0,subtasks:[{id:5,text:"Setup environment",done:!0,expanded:!0,subtasks:[]},{id:6,text:"Write components",done:!1,expanded:!0,subtasks:[]}]}],Ba=7,D="";const Ra=n(backgroundColor(o.bgCard).padding("32px").borderRadius("16px").border(`1px solid ${o.border}`).marginBottom("32px")),za=n(padding("10px 14px").backgroundColor(o.bgLight).color(o.text).border(`1px solid ${o.border}`).borderRadius("8px").fontSize("14px").outline("none").flex("1").transition("border-color 0.2s")),Aa=n(padding("10px 20px").backgroundColor(o.primary).color(o.bg).border("none").borderRadius("8px").fontSize("14px").fontWeight("600").cursor("pointer").transition("all 0.2s")),Ia=n(marginBottom("8px")),Na=n(display("flex").alignItems("center").gap("10px").padding("10px 14px").backgroundColor(o.bgLight).borderRadius("8px").transition("all 0.2s")),Ea=n(width("24px").height("24px").backgroundColor("transparent").border("none").color(o.textMuted).cursor("pointer").fontSize("12px").display("flex").alignItems("center").justifyContent("center").borderRadius("4px").transition("all 0.2s")),Ma=n(width("18px").height("18px").cursor("pointer")),Wa=n(marginLeft("auto").padding("4px 8px").backgroundColor("transparent").color(o.textDim).border("none").borderRadius("4px").cursor("pointer").fontSize("16px").transition("all 0.2s")),$a=n(fontSize("12px").color(o.textDim).marginLeft("8px")),Da=n(marginLeft("34px").marginTop("8px")),La=n(marginLeft("34px").marginTop("8px")),Fa=n(padding("6px 10px").backgroundColor(o.bg).color(o.text).border(`1px solid ${o.border}`).borderRadius("6px").fontSize("13px").outline("none").width("200px").transition("border-color 0.2s"));function Ha(e){return{id:Ba++,text:e,done:!1,subtasks:[],expanded:!0}}function Me(e,r){const i=Ha(e);r?r.subtasks.push(i):oe.push(i),update()}function ja(e){e.done=!e.done;function r(i,s){i.done=s,i.subtasks.forEach(l=>r(l,s))}r(e,e.done),update()}function Oa(e){e.expanded=!e.expanded,update()}function Ua(e,r){r?r.subtasks=r.subtasks.filter(i=>i.id!==e.id):oe=oe.filter(i=>i.id!==e.id),update()}function yt(e,r){let i="";return div(Ia,div(Na,when(()=>e.subtasks.length>0,button(Ea,()=>e.expanded?"▼":"▶",on("click",()=>Oa(e)),on("mouseenter",s=>{s.target.style.backgroundColor=o.bgCard}),on("mouseleave",s=>{s.target.style.backgroundColor="transparent"}))).else(span(n(width("24px").display("inline-block")))),input(Ma,{style:{accentColor:o.primary}},{type:"checkbox",checked:()=>e.done},on("change",()=>ja(e))),span(n(fontSize("14px").transition("all 0.2s")),{style:()=>({color:e.done?o.textDim:o.text,textDecoration:e.done?"line-through":"none"})},()=>e.text),when(()=>e.subtasks.length>0,span($a,()=>`(${e.subtasks.filter(s=>s.done).length}/${e.subtasks.length})`)),button(Wa,"×",on("click",()=>Ua(e,r)),on("mouseenter",s=>{s.target.style.backgroundColor="rgba(239, 68, 68, 0.1)",s.target.style.color="#ef4444"}),on("mouseleave",s=>{s.target.style.backgroundColor="transparent",s.target.style.color=o.textDim}))),when(()=>e.expanded&&e.subtasks.length>0,div(Da,list(()=>e.subtasks,s=>yt(s,e)))),when(()=>e.expanded,div(La,input(Fa,{type:"text",placeholder:"Add subtask...",value:()=>i},on("input",s=>{i=s.target.value,update()}),on("keydown",s=>{s.key==="Enter"&&i.trim()&&(Me(i.trim(),e),i="",update())}),on("focus",s=>{s.target.style.borderColor=o.primary}),on("blur",s=>{s.target.style.borderColor=o.border})))))}function Ga(){return div(Ra,h3(n(fontSize("18px").fontWeight("600").color(o.text).marginBottom("20px")),"Tasks with Subtasks"),div(t.flex,t.gap8,t.mb24,input(za,{type:"text",placeholder:"Add a new task...",value:()=>D},on("input",e=>{D=e.target.value,update()}),on("keydown",e=>{e.key==="Enter"&&D.trim()&&(Me(D.trim()),D="",update())}),on("focus",e=>{e.target.style.borderColor=o.primary}),on("blur",e=>{e.target.style.borderColor=o.border})),button(Aa,"Add Task",on("click",()=>{D.trim()&&(Me(D.trim()),D="",update())}),on("mouseenter",e=>{e.target.style.backgroundColor=o.primaryHover}),on("mouseleave",e=>{e.target.style.backgroundColor=o.primary}))),when(()=>oe.length>0,div(list(()=>oe,e=>yt(e)))).else(p(n(color(o.textDim).textAlign("center").padding("32px")),"No tasks yet. Add one above!")))}function Qa(){const e=I.find(r=>r.id==="subtasks");return div(t.pageContent,a(n(color(o.textMuted).fontSize("14px").marginBottom("16px").display("inline-block").cursor("pointer")),"← Back to Examples",on("click",r=>{r.preventDefault(),z("examples")})),h1(t.pageTitle,e.title),p(t.pageSubtitle,e.description),Ga(),h2(t.h2,"Source Code"),d(e.code,"typescript"))}const qa=[{id:1,name:"Alice Johnson",email:"alice@example.com",role:"Admin"},{id:2,name:"Bob Smith",email:"bob@example.com",role:"User"},{id:3,name:"Charlie Brown",email:"charlie@example.com",role:"User"},{id:4,name:"Diana Prince",email:"diana@example.com",role:"Admin"},{id:5,name:"Eve Anderson",email:"eve@example.com",role:"User"}];let K="",ce="all";const Va=n(backgroundColor(o.bgCard).padding("32px").borderRadius("16px").border(`1px solid ${o.border}`).marginBottom("32px")),_a=n(padding("10px 14px").backgroundColor(o.bgLight).color(o.text).border(`1px solid ${o.border}`).borderRadius("8px").fontSize("14px").outline("none").flex("1").minWidth("200px").transition("border-color 0.2s")),Ya=n(padding("10px 14px").backgroundColor(o.bgLight).color(o.text).border(`1px solid ${o.border}`).borderRadius("8px").fontSize("14px").outline("none").cursor("pointer").transition("border-color 0.2s")),Ja=n(padding("16px").backgroundColor(o.bgLight).borderRadius("10px").marginBottom("12px").transition("all 0.2s")),Ka=n(display("inline-block").padding("4px 10px").borderRadius("20px").fontSize("12px").fontWeight("600"));function ke(){const e=K.toLowerCase();return qa.filter(r=>{const i=r.name.toLowerCase().includes(e)||r.email.toLowerCase().includes(e),s=ce==="all"||r.role===ce;return i&&s})}function Xa(){return div(Va,h3(n(fontSize("18px").fontWeight("600").color(o.text).marginBottom("20px")),"User Directory"),div(t.flex,t.gap16,t.mb24,n(flexWrap("wrap")),input(_a,{type:"search",placeholder:"Search by name or email...",value:()=>K},on("input",e=>{K=e.target.value,update()}),on("focus",e=>{e.target.style.borderColor=o.primary}),on("blur",e=>{e.target.style.borderColor=o.border})),select(Ya,{value:()=>ce},on("change",e=>{ce=e.target.value,update()}),on("focus",e=>{e.target.style.borderColor=o.primary}),on("blur",e=>{e.target.style.borderColor=o.border}),option({value:"all"},"All Roles"),option({value:"Admin"},"Admins"),option({value:"User"},"Users"))),p(n(fontSize("13px").color(o.textDim).marginBottom("16px")),()=>{const e=ke().length;return`Showing ${e} user${e!==1?"s":""}`}),when(()=>ke().length>0,div(list(()=>ke(),e=>div(Ja,on("mouseenter",r=>{r.currentTarget.style.backgroundColor=o.bgCard}),on("mouseleave",r=>{r.currentTarget.style.backgroundColor=o.bgLight}),div(t.flexBetween,div(h4(n(fontSize("15px").fontWeight("600").color(o.text).marginBottom("4px")),e.name),p(n(fontSize("13px").color(o.textMuted).margin("0")),e.email)),span(Ka,{style:{backgroundColor:e.role==="Admin"?"rgba(132, 204, 22, 0.15)":"rgba(100, 116, 139, 0.15)",color:e.role==="Admin"?o.primary:o.textMuted}},e.role)))))).else(div(n(textAlign("center").padding("32px").color(o.textDim)),()=>K?`No users found matching "${K}"`:"No users found")))}function Za(){const e=I.find(r=>r.id==="search");return div(t.pageContent,a(n(color(o.textMuted).fontSize("14px").marginBottom("16px").display("inline-block").cursor("pointer")),"← Back to Examples",on("click",r=>{r.preventDefault(),z("examples")})),h1(t.pageTitle,e.title),p(t.pageSubtitle,e.description),Xa(),h2(t.h2,"Source Code"),d(e.code,"typescript"))}let B={status:"idle",products:[]},M="phone";const es=n(backgroundColor(o.bgCard).padding("32px").borderRadius("16px").border(`1px solid ${o.border}`).marginBottom("32px")),ts=n(padding("10px 14px").backgroundColor(o.bgLight).color(o.text).border(`1px solid ${o.border}`).borderRadius("8px").fontSize("14px").outline("none").flex("1").transition("border-color 0.2s")),os=n(padding("10px 20px").backgroundColor(o.primary).color(o.bg).border("none").borderRadius("8px").fontSize("14px").fontWeight("600").cursor("pointer").transition("all 0.2s")),rs={backgroundColor:o.bgLight,color:o.textDim,cursor:"not-allowed"},ns=n(display("grid").gap("12px").marginTop("20px")),is=n(padding("16px").backgroundColor(o.bgLight).borderRadius("10px").transition("all 0.2s")),as=n(textAlign("center").padding("32px").color(o.textMuted)),ss=n(padding("16px").backgroundColor("rgba(239, 68, 68, 0.1)").borderRadius("8px").color("#ef4444").marginTop("16px"));async function we(){if(M.trim()){B.status="loading",B.error=void 0,update();try{const e=await fetch(`https://dummyjson.com/products/search?q=${M}`);if(!e.ok)throw new Error("Failed to fetch products");const r=await e.json();B.products=r.products.slice(0,6),B.status="success"}catch(e){B.status="error",B.error=e.message}update()}}function ls(){return div(es,h3(n(fontSize("18px").fontWeight("600").color(o.text).marginBottom("20px")),"Product Search"),div(t.flex,t.gap8,input(ts,{type:"search",placeholder:"Search products...",value:()=>M,disabled:()=>B.status==="loading"},on("input",e=>{M=e.target.value,update()}),on("keydown",e=>{e.key==="Enter"&&we()}),on("focus",e=>{e.target.style.borderColor=o.primary}),on("blur",e=>{e.target.style.borderColor=o.border})),button(os,{disabled:()=>B.status==="loading"||!M.trim(),style:()=>B.status==="loading"||!M.trim()?rs:{}},()=>B.status==="loading"?"Searching...":"Search",on("click",we),on("mouseenter",e=>{B.status!=="loading"&&M.trim()&&(e.target.style.backgroundColor=o.primaryHover)}),on("mouseleave",e=>{B.status!=="loading"&&M.trim()&&(e.target.style.backgroundColor=o.primary)}))),when(()=>B.status==="loading",div(as,"Loading products...")).when(()=>B.status==="error",div(ss,t.flexBetween,span(()=>`Error: ${B.error}`),button(n(padding("6px 12px").backgroundColor("transparent").color("#ef4444").border("1px solid #ef4444").borderRadius("6px").fontSize("13px").cursor("pointer")),"Retry",on("click",we)))).when(()=>B.status==="success"&&B.products.length>0,div(p(n(fontSize("13px").color(o.textDim).marginTop("16px")),()=>`Found ${B.products.length} products`),div(ns,{style:{gridTemplateColumns:"repeat(auto-fill, minmax(200px, 1fr))"}},list(()=>B.products,e=>div(is,on("mouseenter",r=>{r.currentTarget.style.backgroundColor=o.bgCard}),on("mouseleave",r=>{r.currentTarget.style.backgroundColor=o.bgLight}),h4(n(fontSize("14px").fontWeight("600").color(o.text).marginBottom("6px")),e.title),p(n(fontSize("12px").color(o.textDim).margin("0 0 8px 0")),e.category),p(n(fontSize("16px").fontWeight("700").color(o.primary).margin("0")),`$${e.price.toFixed(2)}`)))))).when(()=>B.status==="success"&&B.products.length===0,div(n(textAlign("center").padding("32px").color(o.textDim)),()=>`No products found for "${M}"`)).else(div(n(textAlign("center").padding("32px").color(o.textDim)),"Enter a search term and click Search")))}function ds(){const e=I.find(r=>r.id==="async");return div(t.pageContent,a(n(color(o.textMuted).fontSize("14px").marginBottom("16px").display("inline-block").cursor("pointer")),"← Back to Examples",on("click",r=>{r.preventDefault(),z("examples")})),h1(t.pageTitle,e.title),p(t.pageSubtitle,e.description),ls(),h2(t.h2,"Source Code"),d(e.code,"typescript"))}let L={username:"",email:"",password:"",confirmPassword:""},A={},F=!1,se="idle";const cs=n(backgroundColor(o.bgCard).padding("32px").borderRadius("16px").border(`1px solid ${o.border}`).marginBottom("32px")),ps=n(marginBottom("20px")),us=n(display("block").fontSize("14px").fontWeight("500").color(o.text).marginBottom("8px")),ms=n(width("100%").padding("12px 14px").backgroundColor(o.bgLight).color(o.text).border(`1px solid ${o.border}`).borderRadius("8px").fontSize("14px").outline("none").transition("border-color 0.2s")),gs={borderColor:"#ef4444"},hs=n(fontSize("12px").color("#ef4444").marginTop("6px")),fs=n(width("100%").padding("14px 20px").backgroundColor(o.primary).color(o.bg).border("none").borderRadius("8px").fontSize("14px").fontWeight("600").cursor("pointer").transition("all 0.2s").marginTop("8px")),ys={backgroundColor:o.bgLight,color:o.textDim,cursor:"not-allowed"},bs=n(padding("16px").backgroundColor("rgba(132, 204, 22, 0.1)").borderRadius("8px").color(o.primary).marginBottom("20px").textAlign("center"));function xs(){return A={},L.username.length<3&&(A.username="Username must be at least 3 characters"),L.email.includes("@")||(A.email="Please enter a valid email"),L.password.length<6&&(A.password="Password must be at least 6 characters"),L.password!==L.confirmPassword&&(A.confirmPassword="Passwords do not match"),Object.keys(A).length===0}async function vs(e){if(e.preventDefault(),!xs()){update();return}F=!0,se="idle",update();try{await new Promise(r=>setTimeout(r,1e3)),se="success",L={username:"",email:"",password:"",confirmPassword:""}}catch{se="error"}F=!1,update()}function ne(e,r,i,s){return div(ps,label(us,r),input(ms,{type:i,placeholder:s,value:()=>L[e],disabled:()=>F,style:()=>A[e]?gs:{}},on("input",l=>{L[e]=l.target.value,delete A[e],update()}),on("focus",l=>{A[e]||(l.target.style.borderColor=o.primary)}),on("blur",l=>{A[e]||(l.target.style.borderColor=o.border)})),when(()=>!!A[e],span(hs,()=>A[e])))}function Ss(){return div(cs,h3(n(fontSize("18px").fontWeight("600").color(o.text).marginBottom("20px")),"Sign Up"),when(()=>se==="success",div(bs,"Account created successfully!")),form(on("submit",vs),ne("username","Username","text","Enter username"),ne("email","Email","email","Enter email"),ne("password","Password","password","Enter password"),ne("confirmPassword","Confirm Password","password","Confirm password"),button(fs,{type:"submit",disabled:()=>F,style:()=>F?ys:{}},()=>F?"Creating account...":"Sign Up",on("mouseenter",e=>{F||(e.target.style.backgroundColor=o.primaryHover)}),on("mouseleave",e=>{F||(e.target.style.backgroundColor=o.primary)}))))}function ks(){const e=I.find(r=>r.id==="forms");return div(t.pageContent,a(n(color(o.textMuted).fontSize("14px").marginBottom("16px").display("inline-block").cursor("pointer")),"← Back to Examples",on("click",r=>{r.preventDefault(),z("examples")})),h1(t.pageTitle,e.title),p(t.pageSubtitle,e.description),Ss(),h2(t.h2,"Source Code"),d(e.code,"typescript"))}let bt=[{id:1,name:"Alice",avatar:"A",bio:"Software developer",followers:142},{id:2,name:"Bob",avatar:"B",bio:"Designer",followers:89},{id:3,name:"Charlie",avatar:"C",bio:"Product manager",followers:234}];const ws=n(backgroundColor(o.bgCard).padding("32px").borderRadius("16px").border(`1px solid ${o.border}`).marginBottom("32px")),Cs=n(display("grid").gap("16px")),Ps=n(padding("20px").backgroundColor(o.bgLight).borderRadius("12px").transition("all 0.2s")),Ts=n(width("48px").height("48px").borderRadius("50%").backgroundColor(o.primary).color(o.bg).display("flex").alignItems("center").justifyContent("center").fontSize("20px").fontWeight("600").marginBottom("12px")),Bs=n(fontSize("16px").fontWeight("600").color(o.text).marginBottom("4px")),Rs=n(fontSize("14px").color(o.textMuted).marginBottom("12px")),zs=n(fontSize("13px").color(o.textDim).marginBottom("12px")),As=n(padding("8px 16px").backgroundColor(o.primary).color(o.bg).border("none").borderRadius("6px").fontSize("13px").fontWeight("600").cursor("pointer").transition("all 0.2s"));function Is(e){const r=bt.find(i=>i.id===e);r&&(r.followers++,update())}function Ns(e){return div(Ps,on("mouseenter",r=>{r.currentTarget.style.backgroundColor=o.bgCard,r.currentTarget.style.transform="translateY(-2px)"}),on("mouseleave",r=>{r.currentTarget.style.backgroundColor=o.bgLight,r.currentTarget.style.transform="translateY(0)"}),div(Ts,e.avatar),h4(Bs,e.name),p(Rs,e.bio),p(zs,()=>`${e.followers} followers`),button(As,"Follow",on("click",()=>Is(e.id)),on("mouseenter",r=>{r.target.style.backgroundColor=o.primaryHover}),on("mouseleave",r=>{r.target.style.backgroundColor=o.primary})))}function Es(e){return div(Cs,{style:{gridTemplateColumns:"repeat(auto-fill, minmax(200px, 1fr))"}},list(()=>e,r=>Ns(r)))}function Ms(){return div(ws,h3(n(fontSize("18px").fontWeight("600").color(o.text).marginBottom("20px")),"User Directory"),p(n(fontSize("14px").color(o.textMuted).marginBottom("20px")),"This example shows reusable component functions."),Es(bt))}function Ws(){const e=I.find(r=>r.id==="nested");return div(t.pageContent,a(n(color(o.textMuted).fontSize("14px").marginBottom("16px").display("inline-block").cursor("pointer")),"← Back to Examples",on("click",r=>{r.preventDefault(),z("examples")})),h1(t.pageTitle,e.title),p(t.pageSubtitle,e.description),Ms(),h2(t.h2,"Source Code"),d(e.code,"typescript"))}let J=!1;const $s=n(backgroundColor(o.bgCard).padding("32px").borderRadius("16px").border(`1px solid ${o.border}`).marginBottom("32px")),Ds=n(padding("12px 24px").backgroundColor(o.primary).color(o.bg).border("none").borderRadius("8px").fontSize("14px").fontWeight("600").cursor("pointer").transition("all 0.2s").marginBottom("24px")),Ls=n(width("200px").height("200px").borderRadius("16px").display("flex").alignItems("center").justifyContent("center").fontSize("16px").fontWeight("600").color(o.bg).margin("0 auto"));function Fs(){const e="nuclo-demo-pulse-keyframes";if(document.getElementById(e))return;const r=document.createElement("style");r.id=e,r.textContent="@keyframes pulse { from { transform: scale(1); opacity: 0.85; } to { transform: scale(1.08); opacity: 1; } }",document.head.appendChild(r)}function Hs(){return Fs(),div($s,h3(n(fontSize("18px").fontWeight("600").color(o.text).marginBottom("20px")),"Animation Demo"),div(n(textAlign("center")),button(Ds,()=>J?"Stop Animation":"Start Animation",on("click",()=>{J=!J,update()}),on("mouseenter",e=>{e.target.style.backgroundColor=o.primaryHover}),on("mouseleave",e=>{e.target.style.backgroundColor=o.primary})),div(Ls,{style:()=>({animation:J?"pulse 600ms ease-in-out infinite alternate":"none",willChange:J?"transform, opacity":"auto",background:`linear-gradient(135deg, ${o.primary} 0%, ${o.primaryDark} 100%)`})},"Animated Box")))}function js(){const e=I.find(r=>r.id==="animations");return div(t.pageContent,a(n(color(o.textMuted).fontSize("14px").marginBottom("16px").display("inline-block").cursor("pointer")),"← Back to Examples",on("click",r=>{r.preventDefault(),z("examples")})),h1(t.pageTitle,e.title),p(t.pageSubtitle,e.description),Hs(),h2(t.h2,"Source Code"),d(e.code,"typescript"))}let Z="home";const Os=n(backgroundColor(o.bgCard).padding("32px").borderRadius("16px").border(`1px solid ${o.border}`).marginBottom("32px")),Us=n(display("flex").gap("8px").marginBottom("24px").paddingBottom("16px").borderBottom(`1px solid ${o.border}`)),Gs=n(padding("10px 20px").backgroundColor("transparent").color(o.textMuted).border(`1px solid ${o.border}`).borderRadius("8px").fontSize("14px").fontWeight("500").cursor("pointer").transition("all 0.2s")),Qs=n(backgroundColor(o.primary).color(o.bg).borderColor(o.primary)),De=n(padding("24px").backgroundColor(o.bgLight).borderRadius("12px").minHeight("150px")),Le=n(fontSize("20px").fontWeight("600").color(o.text).marginBottom("12px")),Fe=n(fontSize("14px").color(o.textMuted).lineHeight("1.6")),He=n(padding("8px 16px").backgroundColor(o.bgCard).color(o.primary).border(`1px solid ${o.border}`).borderRadius("6px").fontSize("13px").cursor("pointer").transition("all 0.2s").marginTop("16px"));function me(e){Z=e,update()}function qs(){return div(De,h3(Le,"Home Page"),p(Fe,"Welcome to our website! This is a simple client-side routing example."),button(He,"Go to About →",on("click",()=>me("about")),on("mouseenter",e=>{e.target.style.borderColor=o.primary}),on("mouseleave",e=>{e.target.style.borderColor=o.border})))}function Vs(){return div(De,h3(Le,"About Page"),p(Fe,"Learn more about us. We're passionate about building great software."),button(He,"Go to Contact →",on("click",()=>me("contact")),on("mouseenter",e=>{e.target.style.borderColor=o.primary}),on("mouseleave",e=>{e.target.style.borderColor=o.border})))}function _s(){return div(De,h3(Le,"Contact Page"),p(Fe,"Get in touch! We'd love to hear from you."),button(He,"Go Home →",on("click",()=>me("home")),on("mouseenter",e=>{e.target.style.borderColor=o.primary}),on("mouseleave",e=>{e.target.style.borderColor=o.border})))}const Ys=n(),Ce=(e,r)=>{const i=()=>Z===r;return button(Gs,()=>i()?Qs:Ys,e,on("click",()=>{me(r)}))};function Js(){return div(Os,h3(n(fontSize("18px").fontWeight("600").color(o.text).marginBottom("20px")),"Mini Router Demo"),nav(Us,Ce("Home","home"),Ce("About","about"),Ce("Contact","contact")),when(()=>Z==="home",qs()).when(()=>Z==="about",Vs()).when(()=>Z==="contact",_s()))}function Ks(){const e=I.find(r=>r.id==="routing");return div(t.pageContent,a(n(color(o.textMuted).fontSize("14px").marginBottom("16px").display("inline-block").cursor("pointer")),"← Back to Examples",on("click",r=>{r.preventDefault(),z("examples")})),h1(t.pageTitle,e.title),p(t.pageSubtitle,e.description),Js(),h2(t.h2,"Source Code"),d(e.code,"typescript"))}let Xs=[{id:1,name:"Wireless Headphones",description:"Premium noise-canceling headphones with 30-hour battery.",price:299.99,image:"🎧",inStock:!0},{id:2,name:"Smart Watch",description:"Track your fitness, receive notifications, and more.",price:399.99,image:"⌚",inStock:!0},{id:3,name:"Portable Speaker",description:"Waterproof speaker with incredible bass and clarity.",price:149.99,image:"🔊",inStock:!1}];const Zs=n(backgroundColor(o.bgCard).padding("32px").borderRadius("16px").border(`1px solid ${o.border}`).marginBottom("32px")),el=n(textAlign("center").marginBottom("24px")),tl=n(fontSize("24px").fontWeight("700").color(o.text).marginBottom("8px")),ol=n(fontSize("14px").color(o.textMuted)),rl=n(display("grid").gap("20px")),nl=n(backgroundColor(o.bgLight).borderRadius("12px").overflow("hidden").transition("all 0.3s").cursor("pointer"),{hover:boxShadow("0 10px 40px rgba(0,0,0,0.2)").transform("translateY(-4px)")}),il=n(position("relative").height("140px").display("flex").alignItems("center").justifyContent("center").fontSize("48px")),al=n(position("absolute").top("0").left("0").right("0").bottom("0").backgroundColor("rgba(0,0,0,0.6)").display("flex").alignItems("center").justifyContent("center")),sl=n(color("white").fontSize("14px").fontWeight("600")),ll=n(padding("16px")),dl=n(fontSize("16px").fontWeight("600").color(o.text).marginBottom("8px")),cl=n(fontSize("13px").color(o.textMuted).lineHeight("1.5").marginBottom("16px")),pl=n(display("flex").justifyContent("space-between").alignItems("center")),ml=n(fontSize("18px").fontWeight("700").color(o.primary)),gl=n(padding("8px 16px").borderRadius("6px").border("none").fontSize("13px").fontWeight("600").cursor("pointer").transition("all 0.2s"),{hover:backgroundColor(o.primaryHover)});function hl(e){return div(nl,div(il,{style:{background:`linear-gradient(135deg, ${o.bgCard} 0%, ${o.bgLight} 100%)`}},span(n(transition("transform 0.3s"),{hover:transform("scale(1.1)")}),e.image),when(()=>!e.inStock,div(al,span(sl,"Out of Stock")))),div(ll,h4(dl,e.name),p(cl,e.description),div(pl,span(ml,`$${e.price.toFixed(2)}`),button(gl,{style:()=>({backgroundColor:e.inStock?o.primary:o.bgCard,color:e.inStock?o.bg:o.textDim,cursor:e.inStock?"pointer":"not-allowed"})},on("click",()=>{e.inStock&&alert(`Added ${e.name} to cart!`)}),e.inStock?"Add to Cart":"Unavailable"))))}function fl(){return div(Zs,div(el,h3(tl,"Featured Products"),p(ol,"Discover our latest collection")),div(rl,{style:{gridTemplateColumns:"repeat(auto-fill, minmax(220px, 1fr))"}},list(()=>Xs,e=>hl(e))))}function yl(){const e=I.find(r=>r.id==="styled-card");return div(t.pageContent,a(n(color(o.textMuted).fontSize("14px").marginBottom("16px").display("inline-block").cursor("pointer")),"← Back to Examples",on("click",r=>{r.preventDefault(),z("examples")})),h1(t.pageTitle,e.title),p(t.pageSubtitle,e.description),fl(),h2(t.h2,"Source Code"),d(e.code,"typescript"))}zi();Ii();const bl=div(Yi(),main({style:{minHeight:"calc(100vh - 160px)",paddingTop:"40px"}},when(()=>R()==="home",ra()).when(()=>R()==="getting-started",na()).when(()=>R()==="core-api",ia()).when(()=>R()==="tag-builders",aa()).when(()=>R()==="styling",sa()).when(()=>R()==="pitfalls",la()).when(()=>R()==="examples",ya()).when(()=>R()==="example-counter",Sa()).when(()=>R()==="example-todo",Ta()).when(()=>R()==="example-subtasks",Qa()).when(()=>R()==="example-search",Za()).when(()=>R()==="example-async",ds()).when(()=>R()==="example-forms",ks()).when(()=>R()==="example-nested",Ws()).when(()=>R()==="example-animations",js()).when(()=>R()==="example-routing",Ks()).when(()=>R()==="example-styled-card",yl())),Ji());render(bl,document.getElementById("app"));
