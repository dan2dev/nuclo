...
export const examplesContent: ExampleContent[] = [
  {
    id: 'counter',
    title: 'Counter',
    description: `The classic counter example showing basic state management and event handling.`,
    code: `import 'nuclo';
...
render(app, document.body);`,
  },
  {
    id: 'todo',
    title: 'Todo List',
    description: `A complete todo application with add, toggle, delete, and filter functionality.`,
    code: `import 'nuclo';
...
render(app, document.body);`,
  },
  {
    ...
    description: `A todo list with recursive subtasks, demonstrating nested list() and when() composition.`,
    code: `import 'nuclo';
...
render(app, document.body);`,
  },
  {
    id: 'async',
    title: 'Async Loading',
    description: `Handling asynchronous operations with loading states and error handling.`,
    code: `import 'nuclo';
...
render(app, document.body);`,
  },
  {
    ...
    description: `Creating reusable component-like functions.`,
    code: `import 'nuclo';
...
render(app, document.body);`,
  },
  {
    id: 'animations',
    title: 'Animations',
    description: `Smooth transitions with CSS keyframes and dynamic style functions — pulse, float, glow and staggered orbs.`,
    code: `import 'nuclo';
  ...
  div(
    ...
    [0, 1, 2].map((i) =>
      div(
        ...
        {
          style: () => ({
            animation: isAnimating ? 'pulse 800ms ease-in-out infinite alternate' : 'none',
...
render(app, document.body);`,
  },
  {
    ...
    description: `Client-side routing without a framework.`,
    code: `import 'nuclo';
...
render(app, document.body);`,
  },
  {
    id: 'styled-card',
    title: 'Styled Card',
    description: `Using nuclo's CSS-in-JS styling system to create a polished product card component with hover effects.`,
    code: `import 'nuclo';
