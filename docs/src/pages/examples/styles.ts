...
export const es = {
  ...
  hero: css({ animation: `${animations.riseIn} 0.58s cubic-bezier(0.22, 1, 0.36, 1) both`, position: "relative", borderRadius: "28px", backgroundColor: colors.bgCard, boxShadow: "var(--c-shadow)", padding: "44px 40px", "@media (max-width: 600px)": { padding: "30px 22px", borderRadius: "22px" } }),
  ...
  cardBadge: css({ display: "inline-flex", alignItems: "center", gap: "5px", fontSize: "0.7rem", fontWeight: "800", letterSpacing: "0", textTransform: "uppercase", color: colors.primary }),
  ...
  tab: css({ fontSize: "0.8rem", fontWeight: "700", color: colors.textMuted, padding: "8px 12px", borderBottom: "2px solid transparent", borderRadius: "6px 6px 0 0", cursor: "pointer", backgroundColor: "transparent", borderTop: "none", borderLeft: "none", borderRight: "none", fontFamily: sans, hover: { color: colors.textDim, backgroundColor: colors.bgSecondary } }),
  ...
  previewPane: css({ padding: "30px 24px", height: "320px", overflow: "auto", display: "flex", flexDirection: "column", alignItems: "center", backgroundColor: colors.bgCode, "&::before": { content: "''", flex: "1" }, "&::after": { content: "''", flex: "1" }, "@media (max-width: 600px)": { height: "260px", padding: "24px 16px" } }),
  ...
  button: css({ padding: "9px 22px", borderRadius: "9999px", fontSize: "0.875rem", fontWeight: "600", cursor: "pointer", color: colors.textDim, backgroundColor: colors.bgSecondary, fontFamily: sans, hover: { color: colors.text, backgroundColor: colors.bgLight } }),
  ...
  input: css({ flex: "1", padding: "9px 13px", borderRadius: "6px", border: `1px solid ${colors.borderLight}`, backgroundColor: colors.bgSecondary, color: colors.text, fontFamily: sans, fontSize: "0.875rem", outline: "none", focus: { borderColor: colors.primary } }),
  list: css({ display: "flex", flexDirection: "column", gap: "6px" }),
  item: css({ display: "flex", alignItems: "center", gap: "10px", padding: "9px 12px", borderRadius: "6px", backgroundColor: colors.bgSecondary, fontSize: "0.875rem" }),
  itemText: css({ flex: "1" }),
  itemDoneText: css({ textDecoration: "line-through", color: colors.textMuted }),
  itemDelete: css({ color: colors.textMuted, backgroundColor: "transparent", border: "none", fontSize: "1rem", cursor: "pointer", padding: "0 4px", fontFamily: "inherit", hover: { color: "#ff6b6b" } }),
  ...
  filter: css({ padding: "4px 12px", borderRadius: "999px", fontSize: "0.78rem", fontWeight: "500", cursor: "pointer", border: `1px solid ${colors.borderLight}`, color: colors.textMuted, backgroundColor: "transparent", fontFamily: "inherit", hover: { color: colors.textDim } }),
  filterActive: css({ backgroundColor: colors.primaryAlpha08, color: colors.primary }),
  ...
  userCard: css({ display: "flex", alignItems: "center", gap: "12px", padding: "10px 12px", borderRadius: "6px", backgroundColor: colors.bgSecondary, marginBottom: "6px" }),
