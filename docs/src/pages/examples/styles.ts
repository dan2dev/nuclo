...
export const es = {
  ...
  cardBadge: css({ display: "inline-flex", alignItems: "center", gap: "5px", fontSize: "0.7rem", fontWeight: "800", letterSpacing: "0", textTransform: "uppercase", padding: "3px 9px", borderRadius: "999px", backgroundColor: colors.primaryAlpha08, color: colors.primary }),
  ...
  button: css({ padding: "9px 22px", borderRadius: "9999px", fontSize: "0.875rem", fontWeight: "600", cursor: "pointer", color: colors.textDim, backgroundColor: colors.bgSecondary, transition: "all 0.18s ease", fontFamily: sans, hover: { color: colors.text, backgroundColor: colors.bgLight } }),
