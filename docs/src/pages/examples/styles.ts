...
export const es = {
  ...
  kicker: css({ fontFamily: mono, fontSize: "0.72rem", fontWeight: "600", letterSpacing: "0.1em", textTransform: "uppercase", color: colors.accentSecondary, marginBottom: "12px" }),
  title: css({ maxWidth: "660px", fontSize: "3rem", fontWeight: "700", lineHeight: "1.08", marginBottom: "16px", "@media (max-width: 600px)": { fontSize: "2.15rem" } }),
  ...
  cardBadge: css({ display: "inline-flex", alignItems: "center", gap: "5px", fontSize: "0.7rem", fontWeight: "600", letterSpacing: "0.06em", textTransform: "uppercase", padding: "3px 9px", borderRadius: "999px", backgroundColor: colors.primaryAlpha08, color: colors.primary, border: `1px solid ${colors.borderPrimary}` }),
  cardNumber: css({ fontFamily: mono, fontSize: "0.72rem", fontWeight: "700", color: colors.textMuted }),
  cardTitle: css({ fontSize: "1.08rem", fontWeight: "700", marginBottom: "5px" }),
  ...
  tab: css({ fontSize: "0.8rem", fontWeight: "500", color: colors.textMuted, padding: "8px 12px", borderBottom: "2px solid transparent", borderRadius: "6px 6px 0 0", transition: "all 0.18s ease", cursor: "pointer", backgroundColor: "transparent", borderTop: "none", borderLeft: "none", borderRight: "none", fontFamily: sans, hover: { color: colors.textDim, backgroundColor: colors.bgSecondary } }),
  ...
  countLabel: css({ fontSize: "0.78rem", color: colors.textMuted, letterSpacing: "0.05em", marginBottom: "24px" }),
  ...
  avatar: css({ width: "34px", height: "34px", borderRadius: "50%", backgroundColor: colors.primaryAlpha08, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.75rem", fontWeight: "700", color: colors.primary, flexShrink: 0 }),
