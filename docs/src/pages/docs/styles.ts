...
export const ds = {
  ...
  content: css("pages-docs-styles-content", { padding: "0 0 76px", maxWidth: "820px", width: "100%", minWidth: "0", overflowX: "hidden", ...contentTypography, "@media (max-width: 1180px)": { maxWidth: "100%" }, "@media (max-width: 900px)": { padding: "0 0 60px", maxWidth: "100%" }, "@media (max-width: 600px)": { "& h1": { raw: { "font-size": "2rem" } }, "& h2": { raw: { "font-size": "1.28rem" } } } }),
  ...
  apiSig: css("pages-docs-styles-apiSig", { fontFamily: mono, fontSize: "0.82rem", backgroundColor: colors.bgCode, borderLeft: `3px solid ${colors.accentSecondary}`, borderRadius: "8px", padding: "14px 18px", margin: "16px 0 20px", color: colors.text, overflowX: "auto", lineHeight: "1.7", raw: { "scrollbar-width": "thin" }, maxWidth: "100%", "& .kw": { color: "var(--c-tok-keyword)", fontStyle: "normal" }, "& .fn": { color: "var(--c-tok-fn)", fontStyle: "normal" }, "& .ty": { color: "var(--c-tok-type)", fontStyle: "normal" }, "& .pt": { color: "var(--c-tok-punct)", fontStyle: "normal" }, "& .pr": { color: "var(--c-tok-prop)", fontStyle: "normal" } }),
