...
const contentTypography = {
  ...
  "& .code-block-frame": { raw: { margin: "22px 0", "background-color": "var(--c-bg-code)", border: "1px solid var(--c-border)", "border-radius": "14px", overflow: "hidden", "box-shadow": "inset 0 1px 0 rgba(255,255,255,0.04)", "max-width": "100%" } },
  ...
  "& .docs-callout": { raw: { "background-color": "var(--c-primary-alpha-08)", border: "1px solid var(--c-border-primary)", "border-left": "3px solid var(--c-primary)", "border-radius": "14px", padding: "16px 18px", margin: "20px 0", "font-size": "0.9rem", color: "var(--c-text-dim)", animation: `${animations.softPulse} 4.2s ease-in-out infinite` } },
...
export const ds = {
  ...
  hero: css({ position: "relative", animation: `${animations.riseIn} 0.58s cubic-bezier(0.22, 1, 0.36, 1) both`, borderRadius: "28px", border: `1px solid ${colors.border}`, backgroundColor: colors.bgCard, padding: "28px 20px 32px", marginBottom: "40px", "@media (min-width: 600px)": { padding: "44px 40px 48px" } }),
  ...
  metaCard: css({ backgroundColor: colors.bgSecondary, border: `1px solid ${colors.border}`, borderRadius: "14px", padding: "14px 16px", minWidth: "0", transition: "transform 0.2s ease, border-color 0.2s ease, box-shadow 0.2s ease", hover: { transform: "translateY(-2px)", borderColor: colors.borderLight, boxShadow: "0 14px 32px -24px rgba(0,0,0,0.28)" } }),
  ...
  sectionNumber: css({ display: "inline-flex", alignItems: "center", justifyContent: "center", minWidth: "28px", height: "24px", padding: "0 8px", borderRadius: "9999px", backgroundColor: colors.primaryAlpha08, border: `1px solid ${colors.borderPrimary}`, color: colors.primary, fontFamily: mono, fontSize: "0.68rem", fontWeight: "800" }),
  ...
  railCard: css({ border: `1px solid ${colors.border}`, backgroundColor: colors.bgCard, borderRadius: "14px", padding: "14px", transition: "transform 0.2s ease, border-color 0.2s ease, box-shadow 0.2s ease", hover: { transform: "translateY(-2px)", borderColor: colors.borderLight, boxShadow: "0 14px 30px -24px rgba(0,0,0,0.25)" } }),
