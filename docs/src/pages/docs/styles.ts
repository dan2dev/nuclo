...
export const ds = {
  ...
  hero: css({ position: "relative", animation: `${animations.riseIn} 0.58s cubic-bezier(0.22, 1, 0.36, 1) both`, borderRadius: "28px", backgroundColor: colors.bgCard, boxShadow: "var(--c-shadow)", padding: "28px 20px 32px", marginBottom: "40px", "@media (min-width: 600px)": { padding: "44px 40px 48px" } }),
  ...
  mobileLink: css({ flex: "0 0 auto", fontSize: "0.82rem", color: colors.textDim, borderRadius: "999px", padding: "6px 11px", backgroundColor: colors.bgCard }),
  mobileLinkActive: css({ color: colors.primary, backgroundColor: colors.primaryAlpha08 }),
