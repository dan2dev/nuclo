...
const contentTypography = {
  ...
  "& .code-block-frame": { raw: { margin: "22px 0", "background-color": "var(--c-bg-code)", "border-radius": "14px", overflow: "hidden", "box-shadow": "inset 0 1px 0 rgba(255,255,255,0.04)", "max-width": "100%" } },
  "& .code-block-header": { raw: { display: "flex", "align-items": "center", "justify-content": "space-between", "min-height": "38px", padding: "9px 16px", "background-color": "var(--c-bg-secondary)" } },
...
export const ds = {
  ...
  progress: css("pages-docs-styles-progress", { position: "fixed", top: "76px", left: "0", right: "0", zIndex: 190, height: "2px", pointerEvents: "none", backgroundColor: "transparent" }),
  progressFill: css("pages-docs-styles-progressFill", { width: "var(--docs-progress)", height: "100%", backgroundColor: colors.primary }),

  sidebar: css("pages-docs-styles-sidebar", { padding: "8px 0 44px", position: "sticky", top: "96px", height: "calc(100vh - 112px)", overflowY: "auto", alignSelf: "start", "&::-webkit-scrollbar": { width: "4px" }, "&::-webkit-scrollbar-track": { backgroundColor: "transparent" }, "&::-webkit-scrollbar-thumb": { backgroundColor: colors.borderLight, borderRadius: "2px" }, "@media (max-width: 900px)": { display: "none" } }),
  sidebarHead: css("pages-docs-styles-sidebarHead", { margin: "0 0 22px", padding: "0 0 18px", borderBottom: `1px solid ${colors.border}` }),
  sidebarKicker: css("pages-docs-styles-sidebarKicker", { fontFamily: mono, fontSize: "0.68rem", letterSpacing: "0", textTransform: "uppercase", color: colors.primary, marginBottom: "4px", fontWeight: "800" }),
  sidebarTitle: css("pages-docs-styles-sidebarTitle", { fontSize: "1.05rem", fontWeight: "800", color: colors.text }),
  sidebarGroup: css("pages-docs-styles-sidebarGroup", { marginBottom: "26px" }),
  sidebarGroupTitle: css("pages-docs-styles-sidebarGroupTitle", { fontSize: "0.7rem", fontWeight: "800", letterSpacing: "0", textTransform: "uppercase", color: colors.textMuted, marginBottom: "8px" }),
  sidebarLink: css("pages-docs-styles-sidebarLink", { display: "block", fontSize: "0.86rem", color: colors.textDim, padding: "8px 10px 8px 12px", borderLeft: "2px solid transparent", borderRadius: "0 8px 8px 0", cursor: "pointer", hover: { color: colors.text, backgroundColor: colors.bgSecondary } }),
  sidebarLinkActive: css("pages-docs-styles-sidebarLinkActive", { color: colors.primary, backgroundColor: colors.primaryAlpha08, borderLeftColor: colors.primary, fontWeight: "800", hover: { color: colors.primary, backgroundColor: colors.primaryAlpha08 } }),

  content: css("pages-docs-styles-content", { padding: "0 0 76px", maxWidth: "820px", width: "100%", minWidth: "0", ...contentTypography, "@media (max-width: 1180px)": { maxWidth: "100%" }, "@media (max-width: 900px)": { padding: "0 0 60px", maxWidth: "100%" }, "@media (max-width: 600px)": { "& h1": { raw: { "font-size": "2rem" } }, "& h2": { raw: { "font-size": "1.28rem" } } } }),
  ...
  mobileToc: css("pages-docs-styles-mobileToc", { display: "none", "@media (max-width: 900px)": { display: "flex", gap: "8px", position: "sticky", top: "76px", zIndex: 40, overflowX: "auto", padding: "12px 0", margin: "28px 0 0", backgroundColor: colors.bg, borderBottom: `1px solid ${colors.border}`, raw: { "scrollbar-width": "none" }, "&::-webkit-scrollbar": { display: "none" } } }),
  mobileLink: css("pages-docs-styles-mobileLink", { flex: "0 0 auto", fontSize: "0.82rem", color: colors.textDim, borderRadius: "999px", padding: "6px 11px", backgroundColor: colors.bgCard }),
  mobileLinkActive: css("pages-docs-styles-mobileLinkActive", { color: colors.primary, backgroundColor: colors.primaryAlpha08 }),

  section: css("pages-docs-styles-section", { animation: `${animations.riseIn} 0.58s cubic-bezier(0.22, 1, 0.36, 1) both`, paddingTop: "46px", marginTop: "46px", borderTop: `1px solid ${colors.border}`, raw: { "scroll-margin-top": "104px" }, hover: { "& .section-anchor": { opacity: "1" } }, "@media (max-width: 600px)": { paddingTop: "34px", marginTop: "34px" } }),
  ...
  sectionMeta: css("pages-docs-styles-sectionMeta", { display: "flex", alignItems: "center", gap: "10px", marginBottom: "8px" }),
  sectionNumber: css("pages-docs-styles-sectionNumber", { display: "inline-flex", alignItems: "center", justifyContent: "center", minWidth: "28px", height: "24px", padding: "0 8px", borderRadius: "9999px", backgroundColor: colors.primaryAlpha08, color: colors.primary, fontFamily: mono, fontSize: "0.68rem", fontWeight: "800" }),
  sectionKicker: css("pages-docs-styles-sectionKicker", { fontFamily: mono, fontSize: "0.72rem", fontWeight: "800", letterSpacing: "0", textTransform: "uppercase", color: colors.accentSecondary, display: "inline-flex" }),
  ...
  apiHeadingRow: css("pages-docs-styles-apiHeadingRow", { display: "flex", alignItems: "center", gap: "8px", margin: "12px 0 10px" }),
  apiLabel: css("pages-docs-styles-apiLabel", { fontSize: "0.75rem", color: colors.textMuted }),
  apiSig: css("pages-docs-styles-apiSig", { fontFamily: mono, fontSize: "0.82rem", backgroundColor: colors.bgCode, borderLeft: `3px solid ${colors.accentSecondary}`, borderRadius: "8px", padding: "14px 18px", margin: "16px 0 20px", color: colors.text, overflowX: "auto", lineHeight: "1.7", whiteSpace: "pre-wrap", raw: { "scrollbar-width": "thin" }, maxWidth: "100%", "& .kw": { color: "var(--c-tok-keyword)", fontStyle: "normal" }, "& .fn": { color: "var(--c-tok-fn)", fontStyle: "normal" }, "& .ty": { color: "var(--c-tok-type)", fontStyle: "normal" }, "& .pt": { color: "var(--c-tok-punct)", fontStyle: "normal" }, "& .pr": { color: "var(--c-tok-prop)", fontStyle: "normal" } }),
  apiTag: css("pages-docs-styles-apiTag", { display: "inline-block", fontSize: "0.7rem", fontWeight: "800", letterSpacing: "0", textTransform: "uppercase", padding: "2px 8px", borderRadius: "4px", verticalAlign: "middle" }),
  apiTagFn: css("pages-docs-styles-apiTagFn", { backgroundColor: "rgba(232,200,122,0.15)", color: "var(--c-tok-fn)" }),
  apiTagType: css("pages-docs-styles-apiTagType", { backgroundColor: "rgba(125,214,232,0.12)", color: "var(--c-tok-type)" }),

  rail: css("pages-docs-styles-rail", { position: "sticky", top: "96px", alignSelf: "start", display: "flex", flexDirection: "column", gap: "12px", "@media (max-width: 1180px)": { display: "none" } }),
  railCard: css("pages-docs-styles-railCard", { backgroundColor: colors.bgCard, borderRadius: "14px", padding: "14px", transition: "transform 0.2s ease", hover: { transform: "translateY(-2px)", boxShadow: "0 14px 30px -24px rgba(0,0,0,0.25)" } }),
  railKicker: css("pages-docs-styles-railKicker", { fontFamily: mono, fontSize: "0.66rem", fontWeight: "800", letterSpacing: "0", textTransform: "uppercase", color: colors.textMuted, marginBottom: "8px" }),
  railTitle: css("pages-docs-styles-railTitle", { fontSize: "0.92rem", fontWeight: "800", lineHeight: "1.3", color: colors.text }),
  railGroup: css("pages-docs-styles-railGroup", { marginTop: "4px", fontSize: "0.76rem", color: colors.accentSecondary }),
  railNav: css("pages-docs-styles-railNav", { display: "flex", flexDirection: "column", gap: "4px" }),
  railLink: css("pages-docs-styles-railLink", { display: "block", borderRadius: "6px", padding: "7px 8px", color: colors.textDim, fontSize: "0.8rem", lineHeight: "1.35", hover: { color: colors.text, backgroundColor: colors.bgSecondary } }),
  railLinkActive: css("pages-docs-styles-railLinkActive", { color: colors.primary, backgroundColor: colors.primaryAlpha08 }),
};
