...
const contentTypography = {
  "& h1": { raw: { "font-size": "2.7rem", "font-weight": "700", "margin-bottom": "14px", "line-height": "1.08" } },
  "& h2": { raw: { "font-size": "1.55rem", "font-weight": "700", margin: "0", "line-height": "1.24" } },
  "& h3": { raw: { "font-size": "1.05rem", "font-weight": "600", "margin-top": "32px", "margin-bottom": "10px", "scroll-margin-top": "80px" } },
  ...
  "& .code-block-frame": { raw: { margin: "22px 0", "background-color": "var(--c-bg-code)", border: "1px solid var(--c-border)", "border-radius": "8px", overflow: "hidden", "box-shadow": "inset 0 1px 0 rgba(255,255,255,0.02)", "max-width": "100%" } },
...
export const ds = {
  layout: css({ display: "grid", gridTemplateColumns: "220px minmax(0, 820px) 174px", gap: "32px", maxWidth: "1304px", margin: "0 auto", padding: "0 28px", minHeight: "100vh", alignItems: "start", raw: { "scrollbar-width": "thin" }, "@media (max-width: 1180px)": { gridTemplateColumns: "224px minmax(0, 1fr)", maxWidth: "1080px", gap: "42px" }, "@media (max-width: 900px)": { display: "block", padding: "0 24px" }, "@media (max-width: 600px)": { padding: "0 18px" } }),
  progress: css({ position: "fixed", top: "80px", left: "0", right: "0", zIndex: 190, height: "2px", pointerEvents: "none", backgroundColor: "transparent" }),
  progressFill: css({ width: "var(--docs-progress)", height: "100%", backgroundImage: "linear-gradient(90deg, var(--c-accent-secondary), var(--c-primary), var(--c-accent-cool), var(--c-primary))", backgroundSize: "220% 100%", animation: `${animations.progressSweep} 3s linear infinite`, transition: "width 0.08s linear" }),
  ...
  sidebarKicker: css({ fontFamily: mono, fontSize: "0.68rem", letterSpacing: "0.12em", textTransform: "uppercase", color: colors.primary, marginBottom: "4px" }),
  sidebarTitle: css({ fontSize: "1.05rem", fontWeight: "700", color: colors.text }),
  sidebarGroup: css({ marginBottom: "26px" }),
  sidebarGroupTitle: css({ fontSize: "0.7rem", fontWeight: "600", letterSpacing: "0.1em", textTransform: "uppercase", color: colors.textMuted, marginBottom: "8px" }),
  sidebarLink: css({ display: "block", fontSize: "0.86rem", color: colors.textDim, padding: "7px 10px 7px 12px", borderLeft: "2px solid transparent", borderRadius: "0 6px 6px 0", transition: "all 0.18s ease", cursor: "pointer", hover: { color: colors.text, backgroundColor: colors.bgSecondary } }),
  sidebarLinkActive: css({ color: colors.primary, backgroundColor: colors.primaryAlpha08, borderLeftColor: colors.primary, hover: { color: colors.primary, backgroundColor: colors.primaryAlpha08 } }),
  ...
  hero: css({ animation: `${animations.riseIn} 0.58s cubic-bezier(0.22, 1, 0.36, 1) both`, padding: "6px 0 38px", marginBottom: "2px", borderBottom: `1px solid ${colors.border}`, "@media (max-width: 600px)": { paddingBottom: "28px" } }),
  eyebrow: css({ fontFamily: mono, fontSize: "0.72rem", fontWeight: "600", letterSpacing: "0.1em", textTransform: "uppercase", color: colors.accentSecondary, marginBottom: "12px" }),
  lead: css({ fontSize: "1.05rem", color: colors.textDim, lineHeight: "1.75", maxWidth: "720px", marginBottom: "0" }),
  quickstart: css({ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "18px", marginTop: "24px", padding: "12px 14px 12px 16px", backgroundColor: "color-mix(in srgb, var(--c-bg-card) 82%, transparent)", border: `1px solid ${colors.border}`, borderRadius: "8px", transition: "transform 0.2s ease, border-color 0.2s ease, box-shadow 0.2s ease", hover: { transform: "translateY(-2px)", borderColor: colors.borderPrimary, boxShadow: "0 16px 36px rgba(0,0,0,0.14)" }, "@media (max-width: 600px)": { alignItems: "stretch", flexDirection: "column", gap: "10px" } }),
  ...
  quickstartLabel: css({ fontFamily: mono, fontSize: "0.7rem", letterSpacing: "0.09em", textTransform: "uppercase", color: colors.textMuted, flexShrink: 0 }),
  ...
  metaCard: css({ backgroundColor: colors.bgCard, border: `1px solid ${colors.border}`, borderRadius: "8px", padding: "14px 16px", minWidth: "0", transition: "transform 0.2s ease, border-color 0.2s ease, box-shadow 0.2s ease", hover: { transform: "translateY(-2px)", borderColor: colors.borderLight, boxShadow: "0 14px 32px rgba(0,0,0,0.16)" } }),
  metaValue: css({ fontSize: "1rem", fontWeight: "700", color: colors.text, lineHeight: "1.2", marginBottom: "4px" }),
  metaLabel: css({ fontSize: "0.76rem", color: colors.textMuted }),

  mobileToc: css({ display: "none", "@media (max-width: 900px)": { display: "flex", gap: "8px", position: "sticky", top: "80px", zIndex: 40, overflowX: "auto", padding: "12px 0", margin: "28px 0 0", backgroundColor: colors.bg, borderBottom: `1px solid ${colors.border}`, raw: { "scrollbar-width": "none" }, "&::-webkit-scrollbar": { display: "none" } } }),
  ...
  sectionNumber: css({ display: "inline-flex", alignItems: "center", justifyContent: "center", width: "28px", height: "22px", borderRadius: "5px", backgroundColor: colors.primaryAlpha08, color: colors.primary, fontFamily: mono, fontSize: "0.68rem", fontWeight: "700" }),
  sectionKicker: css({ fontFamily: mono, fontSize: "0.72rem", fontWeight: "600", letterSpacing: "0.1em", textTransform: "uppercase", color: colors.accentSecondary, display: "inline-flex" }),
  ...
  apiTag: css({ display: "inline-block", fontSize: "0.7rem", fontWeight: "600", letterSpacing: "0.06em", textTransform: "uppercase", padding: "2px 8px", borderRadius: "4px", verticalAlign: "middle" }),
  ...
  railCard: css({ border: `1px solid ${colors.border}`, backgroundColor: "color-mix(in srgb, var(--c-bg-card) 86%, transparent)", borderRadius: "8px", padding: "14px", transition: "transform 0.2s ease, border-color 0.2s ease, box-shadow 0.2s ease", hover: { transform: "translateY(-2px)", borderColor: colors.borderLight, boxShadow: "0 14px 30px rgba(0,0,0,0.14)" } }),
  railKicker: css({ fontFamily: mono, fontSize: "0.66rem", fontWeight: "700", letterSpacing: "0.1em", textTransform: "uppercase", color: colors.textMuted, marginBottom: "8px" }),
  railTitle: css({ fontSize: "0.92rem", fontWeight: "700", lineHeight: "1.3", color: colors.text }),
